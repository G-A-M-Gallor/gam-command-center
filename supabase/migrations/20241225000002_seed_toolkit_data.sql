...
INSERT INTO cc_automations (name, description, type, status, trigger_config, last_run, next_run, run_count, success_count, error_count) VALUES
  ...
  ('Client Email Automation', 'Automated email sequences for client onboarding and follow-ups', 'webhook', 'active', '{"trigger": "webhook", "source": "origami_crm", "templates": ["welcome", "follow_up", "contract_reminder"]}', NOW() - INTERVAL '45 minutes', null, 324, 310, 14),
  ('Document Generation', 'Automated contract and agreement generation from templates', 'webhook', 'active', '{"trigger": "api_call", "template_engine": "tiptap", "output_formats": ["pdf", "docx"]}', NOW() - INTERVAL '3 hours', null, 67, 65, 2),
