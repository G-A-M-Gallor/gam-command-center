...
function h2r(p,q,_t){if(_t<0)t+=1;if(_t>1)t-=1;if(_t<1/6)return p+(q-p)*6*t;if(_t<1/2)return q;if(_t<2/3)return p+(q-p)*(2/3-_t)*6;return p}
...
try{var bp=JSON.parse(localStorage.getItem('cc-brand-_profile')||'{}');if(bp.brandPrimary)applyPalette('brand',bp.brandPrimary)}catch(e){}
