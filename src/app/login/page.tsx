...
type OAuthProvider = {
  ...
  tKey: "signInWithGoogle" | "signInWithGithub" | "signInWithFacebook" | "signInWithMicrosoft" | "signInWithApple" | "signInWithLinkedIn";
  brandColor: string;
};

const OAUTH_PROVIDERS: OAuthProvider[] = [
  { id: "google", icon: GoogleIcon, tKey: "signInWithGoogle", brandColor: "#4285F4" },
              ...
              <button
                ...
                onClick={async () => {
                  await supabase.auth.signInWithOAuth({
                    provider: provider.id as "google" | "github" | "facebook" | "azure" | "apple" | "linkedin_oidc",
