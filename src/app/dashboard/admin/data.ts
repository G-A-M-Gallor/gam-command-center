...
export const changelogEntries: ChangelogEntry[] = [
  ...
  {
    id: 'sidebar-redesign',
    feature: 'Sidebar — innovative navigation redesign',
    featureHe: 'סיידבר — עיצוב ניווט חדשני',
    status: 'not-verified', commitStatus: 'uncommitted', workflowStatus: 'todo',
    date: '2026-03-06', phase: 1,
    files: ['src/components/command-center/Sidebar.tsx'],
    notes: 'Redesign the sidebar with a modern, innovative navigation pattern. Enhanced visual hierarchy, micro-interactions, animations, and a unique look that differentiates CC from standard dashboard templates.',
    notesHe: 'עיצוב מחדש של הסיידבר עם דפוס ניווט מודרני וחדשני. היררכיה ויזואלית משופרת, מיקרו-אינטראקציות, אנימציות ומראה ייחודי שמבדיל את CC מתבניות דשבורד סטנדרטיות.',
    purpose: 'The sidebar is the most-seen UI element. An innovative design elevates the entire dashboard feel and creates a memorable product identity for GAM.',
    purposeHe: 'הסיידבר הוא אלמנט הממשק הנראה ביותר. עיצוב חדשני מעלה את תחושת הדשבורד כולו ויוצר זהות מוצר בלתי נשכחת ל-GAM.',
    connectedTo: ['DashboardShell.tsx', 'SettingsContext', 'split-screen-nav'],
  },
  {
    id: 'split-screen-nav',
