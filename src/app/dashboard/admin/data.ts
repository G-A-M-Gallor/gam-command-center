...
export const contexts: ContextEntry[] = [
  { id: 'settings', name: 'SettingsContext', file: 'contexts/SettingsContext.tsx', storageKeys: ['cc-language', 'cc-sidebar-position', 'cc-sidebar-visibility', 'cc-accent-color', 'cc-font-family', 'cc-border-radius', 'cc-density', 'cc-brand-profile', 'cc-custom-accent-hex', 'cc-saved-colors', 'cc-accent-effect'], status: 'active', version: '0.7.0' },
