...
export const widgets: WidgetEntry[] = [
  ...
  { id: 'origami-forms', name: 'Origami Forms', nameHe: 'טפסי Origami', file: 'OrigamiFormsWidget.tsx', defaultSize: '2x', panelMode: 'dropdown', status: 'active', version: '0.1.0', addedDate: '2026-03-08' },
  { id: 'form-submissions', name: 'Form Submissions', nameHe: 'הגשות טפסים', file: 'FormSubmissionsWidget.tsx', defaultSize: '2x', panelMode: 'dropdown', status: 'active', version: '0.1.0', addedDate: '2026-03-08' },
  { id: 'form-scanner', name: 'Document Scanner', nameHe: 'סורק מסמכים', file: 'FormScannerWidget.tsx', defaultSize: '2x', panelMode: 'dropdown', status: 'active', version: '0.1.0', addedDate: '2026-03-08' },
...
export const CHANGELOG_CHECKLISTS: Record<string, DevChecklist> = {
  ...
  'origami-forms-widget':    makeChecklist(true,  true, true, true, true),
  'form-submissions-widget': makeChecklist(true,  true, true, true, true),
  'form-scanner-widget':     makeChecklist(true,  true, true, true, true),
...
export const changelogEntries: ChangelogEntry[] = [
  ...
  {
    id: 'origami-forms-widget',
    feature: 'Origami Forms widget — form status from Origami CRM',
    featureHe: 'ווידג\'ט טפסי Origami — סטטוס טפסים מ-Origami CRM',
    status: 'working',
    commitStatus: 'committed',
    workflowStatus: 'complete',
    date: '2026-03-08',
    phase: 5,
    files: ['src/components/command-center/widgets/OrigamiFormsWidget.tsx', 'src/components/command-center/widgets/WidgetRegistry.ts'],
    route: '/dashboard',
    notes: 'Origami forms list with connection status indicator. Fetches from /api/origami/entities with r.ok check. Shows form name, field count, last-modified. Demo fallback when API unavailable.',
    notesHe: 'רשימת טפסי Origami עם אינדיקטור סטטוס חיבור. שואב מ-/api/origami/entities עם בדיקת r.ok. מציג שם טופס, מספר שדות, עדכון אחרון.',
    purpose: 'Surfaces Origami CRM form entities in the dashboard. Activated from coming-soon to active. Requires ORIGAMI_API_KEY + ORIGAMI_BASE_URL for live data.',
    purposeHe: 'מעלה טפסי Origami CRM לדשבורד. הועבר ממצב coming-soon לפעיל. דורש ORIGAMI_API_KEY + ORIGAMI_BASE_URL לנתונים חיים.',
    connectedTo: ['WidgetRegistry.ts', 'api/origami/entities/route.ts'],
  },
  {
    id: 'form-submissions-widget',
    feature: 'Form Submissions widget — recent form submissions panel',
    featureHe: 'ווידג\'ט הגשות טפסים — פאנל הגשות אחרונות',
    status: 'working',
    commitStatus: 'committed',
    workflowStatus: 'complete',
    date: '2026-03-08',
    phase: 5,
    files: ['src/components/command-center/widgets/FormSubmissionsWidget.tsx', 'src/components/command-center/widgets/WidgetRegistry.ts'],
    route: '/dashboard',
    notes: 'Recent form submissions with status indicators (approved/pending/rejected). Demo data with 4 entries. Factory function to prevent stale timestamps. Uses shared timeAgo utility. setTimeout cleanup on unmount.',
    notesHe: 'הגשות טפסים אחרונות עם אינדיקטורי סטטוס (אושר/ממתין/נדחה). נתוני הדגמה של 4 הגשות. פונקציית יצירה למניעת חותמות זמן ישנות.',
    purpose: 'Shows a feed of recent form submissions so users can quickly review and act on incoming data. Activated from coming-soon to active.',
    purposeHe: 'מציג פיד הגשות טפסים אחרונות כדי שמשתמשים יוכלו לסקור ולפעול על נתונים נכנסים. הועבר ממצב coming-soon לפעיל.',
    connectedTo: ['WidgetRegistry.ts', 'lib/utils/timeAgo.ts'],
  },
  {
    id: 'form-scanner-widget',
    feature: 'Document Scanner widget — scanned document verification',
    featureHe: 'ווידג\'ט סורק מסמכים — אימות מסמכים סרוקים',
    status: 'working',
    commitStatus: 'committed',
    workflowStatus: 'complete',
    date: '2026-03-08',
    phase: 5,
    files: ['src/components/command-center/widgets/FormScannerWidget.tsx', 'src/components/command-center/widgets/WidgetRegistry.ts'],
    route: '/dashboard',
    notes: 'Scanned documents panel with verification statuses (verified/needs-review/processing). Demo data with 3 entries. Color-coded status badges. Factory function for timestamps. Uses shared timeAgo utility.',
    notesHe: 'פאנל מסמכים סרוקים עם סטטוסי אימות (מאומת/דורש בדיקה/בעיבוד). נתוני הדגמה של 3 רשומות. תגיות סטטוס צבעוניות.',
    purpose: 'Tracks scanned document status for GAM evidence culture — documents are potential legal evidence. Activated from coming-soon to active.',
    purposeHe: 'עוקב אחר סטטוס מסמכים סרוקים לתרבות התיעוד של GAM — מסמכים הם ראיות משפטיות פוטנציאליות. הועבר ממצב coming-soon לפעיל.',
    connectedTo: ['WidgetRegistry.ts', 'lib/utils/timeAgo.ts'],
  },
  {
