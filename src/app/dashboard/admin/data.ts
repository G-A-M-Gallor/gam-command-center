...
export const CHANGELOG_CHECKLISTS: Record<string, DevChecklist> = {
  ...
  // ── Security + Auth ──
  'auth-system':             makeChecklist(false, true, true,  true, true),
  'security-hardening':      makeChecklist(false, true, true,  true, true),
  'rls-authenticated':       makeChecklist(false, true, true,  true, true),
  ...
  'missing-functional-map-table': makeChecklist(false, false, false, true, false),
  'rls-new-tables':          makeChecklist(false, false, false, true, false),
  ...
  // ── Story Map tab ──
  'value-story-map':         makeChecklist(false, true, true, true, true),
};
