...
export const CHANGELOG_CHECKLISTS: Record<string, DevChecklist> = {
  ...
  // ── Story Map features ──
  'storycard-notes':         makeChecklist(false, false, false, true, false),
  'storycard-diagram':       makeChecklist(false, false, false, true, false),
  // ── UI/UX + Libraries ──
...
export const changelogEntries: ChangelogEntry[] = [
...

  {
    ...
    files: ['src/app/dashboard/functional-map/page.tsx'],
    route: '/dashboard/functional-map',
    notes: 'Page works with demo data but saves fail. Need functional_map_cells table for persistence.',
    notesHe: 'דף עובד עם נתוני הדגמה אבל שמירות נכשלות. צריך טבלת functional_map_cells לשמירה.',
    purpose: 'The 3x5 functional map is a key GAM framework. Without persistence, edits are lost on refresh.',
    purposeHe: 'המפה הפונקציונלית 3×5 היא מסגרת מפתח של GAM. בלי שמירה, עריכות הולכות לאיבוד ברענון.',
  ...
  },
  {
    ...
    date: '2026-03-06',
    files: [],
    notes: 'Need authenticated-user RLS policies for: ai_conversations, doc_templates, doc_versions, doc_shares.',
    notesHe: 'צריך מדיניות RLS למשתמש מאומת עבור: ai_conversations, doc_templates, doc_versions, doc_shares.',
    purpose: 'Without RLS policies, these tables may block authenticated users.',
    purposeHe: 'בלי מדיניות RLS, טבלאות אלה עלולות לחסום משתמשים מאומתים.',
...

  {
    ...
    status: 'not-verified', commitStatus: 'uncommitted', workflowStatus: 'todo',
    date: '2026-03-06', phase: 3,
    files: ['src/components/command-center/StoryCard.tsx', 'src/app/dashboard/story-map/page.tsx'],
    route: '/dashboard/story-map',
  ...
  },
  {
    ...
    status: 'not-verified', commitStatus: 'uncommitted', workflowStatus: 'todo',
    date: '2026-03-06', phase: 3,
    files: ['src/components/command-center/StoryCard.tsx'],
    route: '/dashboard/story-map',
