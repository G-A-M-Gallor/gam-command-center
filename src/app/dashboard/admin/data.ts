import {
  Circle, CheckCircle2, Activity, _Layers, FileEdit, Map, Grid3X3,
  Bot, Palette, Network, Calendar, Zap, Rss, Upload, Settings, Globe, Code2,
  _Shield, HelpCircle, BookOpen, Brain, Users, Compass, MessagesSquare, MessageCircle, FileSignature,
  Inbox, _Star, ArrowRight, PauseCircle, AlertTriangle, Snowflake, XCircle,
  Loader2, Mail, Gauge, Film, CalendarDays, Pencil, Wrench, GraduationCap, _Monitor,
} from 'lucide-react';
import type {
...
export const WORKFLOW_CONFIG: Record<WorkflowStatus, { color: string; bg: string; text: string; icon: React.ElementType; heLabel: string; enLabel: string; order: number }> = {
  ...
  wishlist:   { color: '#c084fc', bg: 'bg-purple-500/10',  text: 'text-purple-400',  icon: _Star,           heLabel: 'רשימת משאלות',    enLabel: 'Wishlist',    order: 1 },
...
export const routes: RouteEntry[] = [
  {
    id: 'dashboard-home', path: '/dashboard', name: 'Dashboard Home', nameHe: 'דשבורד', icon: _Layers,
    phase: 1, status: 'active', version: '0.2.0', addedDate: '2026-03-08',
    descriptionHe: 'עמוד בית של הדשבורד — כרטיסי סטטיסטיקה, פרויקטים אחרונים, אירועי היום, פעולות מהירות',
    descriptionEn: 'Dashboard home — stat cards, recent projects, today events, quick actions',
    components: [
      { id: 'page-header-home', name: 'PageHeader', file: 'components/command-center/PageHeader.tsx', status: 'active' },
    ],
  ...
  },
  {
    ...
    descriptionHe: 'לוח ציור חופשי מבוסס Excalidraw — סקיצות, דיאגרמות ורעיונות ויזואליים. מנהל לוחות עצמאי + שיתוף הגדרות עם Canvas ישויות',
    descriptionEn: 'Freehand whiteboard powered by Excalidraw — sketches, diagrams and visual ideas. Standalone canvas manager + shared settings with Entity Canvas',
    components: [
      { id: 'vcanvas-page', name: 'VCanvasPage', file: 'app/dashboard/vcanvas/page.tsx', status: 'active' },
      { id: 'vcanvas-component', name: 'VCanvas', file: 'components/vcanvas/VCanvas.tsx', status: 'active' },
  ...
  },
  {
    ...
    descriptionEn: 'Accent colors, fonts, 3-layer skins (shell/content/mobile), density, brand _profile, style overrides, integrations hub',
    components: [
  ...
  },
  {
    ...
    phase: 1, status: 'active', version: '0.5.0', addedDate: '2026-03-01',
    descriptionHe: 'מרשם מערכת — routes, widgets, contexts, changelog, dev checklist, סטטיסטיקות',
    descriptionEn: 'System registry — routes, widgets, contexts, changelog, dev checklist, stats',
    components: [],
    contexts: ['SettingsContext'], visible: true, sidebarTab: true,
  },
  {
    id: 'server-health', path: '/dashboard/server-health', name: 'Server Health', nameHe: 'מצב השרת', icon: _Monitor,
  ...
  },
  {
    ...
    phase: 2, status: 'active', version: '0.1.0', addedDate: '2026-03-09',
    descriptionHe: 'ספריית שדות גלובליים — שדה מוגדר פעם אחת ומשמש בכל ישות. תמיכה בשדות מורכבים (composite), select, multi-select, date, person, relation ועוד.',
    descriptionEn: 'Global field library — define once, use in any entity. Supports composite fields, select, multi-select, date, person, relation, and more.',
    components: [
      { id: 'field-library-page', name: 'FieldLibraryPage', file: 'app/dashboard/entities/fields/page.tsx', status: 'active' },
    ],
    contexts: ['SettingsContext'], supabaseTables: ['global_fields', 'field_groups'], visible: true, sidebarTab: true,
    connectedTo: ['entity-types', 'entity-view'],
  },
  {
    id: 'entity-types', path: '/dashboard/entities/types', name: 'Entity Types', nameHe: 'סוגי ישויות', icon: Code2,
    phase: 2, status: 'active', version: '0.1.0', addedDate: '2026-03-09',
    descriptionHe: 'ניהול סוגי ישויות — תבניות שמגדירות אילו שדות מהספרייה להציג. חיבורים many-to-many בין ישויות. דיאגרמת קשרים.',
    descriptionEn: 'Entity type management — templates defining which library fields to show. Many-to-many connections between entities. Connection diagram.',
    components: [
  ...
  {
    id: 'entity-view', path: '/dashboard/entities/[type]', name: 'Entity View', nameHe: 'תצוגת ישות', icon: Code2,
    phase: 2, status: 'active', version: '0.1.0', addedDate: '2026-03-09',
    descriptionHe: 'דף תצוגת ישות — 4 תצוגות (טבלה/לוח/רשימה/לוח שנה). פילטרים לפי כל שדה מטא. inline editing. Board view עם drag & drop. חיפוש חוצה ישויות.',
    descriptionEn: 'Entity view page — 4 views (table/board/list/calendar). Filter by any meta field. Inline editing. Board view with drag & drop. Cross-entity search.',
    components: [
      { id: 'table-view', name: 'TableView', file: 'components/entities/views/TableView.tsx', status: 'active' },
      { id: 'board-view', name: 'BoardView', file: 'components/entities/views/BoardView.tsx', status: 'active' },
      { id: 'list-view', name: 'ListView', file: 'components/entities/views/ListView.tsx', status: 'active' },
  ...
  {
    id: 'entity-detail', path: '/dashboard/entities/[type]/[id]', name: 'Entity Detail', nameHe: 'פרטי ישות', icon: Code2,
    phase: 2, status: 'active', version: '0.1.0', addedDate: '2026-03-09',
    descriptionHe: 'עמוד עריכת ישות בודדת — כותרת עריכה inline, שדות NoteMeta בשני טורים, בעלי עניין, לוג פעילות, השבתה/מחיקה. Breadcrumb חזרה לרשימה.',
    descriptionEn: 'Single entity detail/edit page — inline editable title, two-column layout with NoteMeta fields, stakeholders sidebar, activity feed, deactivate/delete actions. Breadcrumb back to list.',
    components: [
      { id: 'entity-detail-page', name: 'EntityDetailPage', file: 'app/dashboard/entities/[type]/[id]/page.tsx', status: 'active' },
      { id: 'note-meta-detail', name: 'NoteMeta', file: 'components/entities/NoteMeta.tsx', status: 'active' },
  ...
  {
    id: 'audit', path: '/dashboard/audit', name: 'Audit Log', nameHe: 'יומן ביקורת', icon: _Shield,
    phase: 1, status: 'active', version: '1.0.0', addedDate: '2026-03-16',
...
export const widgets: WidgetEntry[] = [
  ...
  { id: 'kpi', name: 'KPIs', nameHe: 'מדדים', file: 'KPIWidget.tsx', defaultSize: '2x', panelMode: 'dropdown', status: 'active', version: '0.1.0', addedDate: '2026-03-08' },
  { id: 'shortcuts', name: 'Quick Links', nameHe: 'קיצורים', file: 'ExternalLinksWidget.tsx', defaultSize: '1x', panelMode: 'dropdown', status: 'active', version: '0.1.0', addedDate: '2026-03-08' },
...
export const contexts: ContextEntry[] = [
  { id: 'settings', name: 'SettingsContext', file: 'contexts/SettingsContext.tsx', storageKeys: ['cc-language', 'cc-sidebar-position', 'cc-sidebar-visibility', 'cc-accent-color', 'cc-font-family', 'cc-border-radius', 'cc-density', 'cc-brand-profile', 'cc-custom-accent-hex', 'cc-saved-colors', 'cc-accent-effect', 'cc-skin-config'], status: 'active', version: '0.8.0' },
  ...
  { id: 'auth', name: 'AuthContext', file: 'contexts/AuthContext.tsx', storageKeys: [], status: 'active', version: '0.2.0' },
  { id: 'toast', name: 'ToastContext', file: 'contexts/ToastContext.tsx', storageKeys: [], status: 'active', version: '0.1.0' },
];
...
export const DEV_CHECKLIST_KEYS: { key: DevChecklistKey; icon: React.ElementType }[] = [
  ...
  { key: 'conflictReview', icon: _Shield },
];
...
export const CHANGELOG_CHECKLISTS: Record<string, DevChecklist> = {
  ...
  'skins-system':            makeChecklist(true,  true, true,  true, true), // deprecated — replaced by theme system
  ...
  'self-audit-fixes':   makeChecklist(true, true, true, true, true),
  'aria-labels-pass':   makeChecklist(true, true, true, true, true),
  'data-cc-id-pass':    makeChecklist(true, true, true, true, true),
  'editor-save-fix':    makeChecklist(true, true, true, true, true),
  'editor-resilience':  makeChecklist(true, true, true, true, true),
  'health-monitoring':  makeChecklist(true, true, true, true, true),
  'ci-testing-pipeline': makeChecklist(true, true, true, true, true),
  // ── Senior Architect Audit — P0 ──
  'api-auth-hardening':              makeChecklist(false, true, true, true, true),
  'sentry-error-tracking':           makeChecklist(false, true, true, true, true),
  'zod-input-validation':            makeChecklist(false, true, true, true, true),
  'unit-tests-editor':               makeChecklist(false, true, true, true, true),
  // ── Senior Architect Audit — P1 ──
  'fix-e2e-tests':                   makeChecklist(false, true, true, true, true),
  'remove-puppeteer':                makeChecklist(false, true, true, true, true),
  'optimistic-locking':              makeChecklist(false, true, true, true, true),
  'real-rls-tests':                  makeChecklist(false, true, true, true, true),
  // ── Senior Architect Audit — P2 ──
  'code-splitting':                  makeChecklist(false, true, true, true, true),
  'consolidate-types':               makeChecklist(false, true, true, true, true),
  'remove-fallback-uuids':           makeChecklist(false, true, true, true, true),
  'scope-providers-widget-boundaries': makeChecklist(false, true, true, true, true),
  // ── Dashboard Pages ──
  ...
  // ── Session 2026-03-08 (batch 2) ──
  'kpi-widget':              makeChecklist(true,  true, true, true, true),
  'shortcuts-widget':        makeChecklist(true,  true, true, true, true),
  'layers-filters':          makeChecklist(true,  true, true, true, true),
  'notifications-supabase':  makeChecklist(true,  true, true, true, true),
  'dashboard-home':          makeChecklist(true,  true, true, true, true),
  'forms-category':          makeChecklist(true,  true, true, true, true),
  'api-route-fixes':         makeChecklist(false, true, true, true, true),
  // ── Session 2026-03-08 (batch 3) — Activated widgets + quality audit ──
  'wati-widget':             makeChecklist(true,  true, true, true, true),
  'team-widget':             makeChecklist(true,  true, true, true, true),
  'quality-audit-fixes':     makeChecklist(false, true, true, true, true),
  'admin-data-sync':         makeChecklist(true,  true, true, true, true),
  // ── Widget Top Bar Redesign V2 ──
  'topbar-v2-bookmarks':     makeChecklist(true,  true, true,  true, true),
  'topbar-v2-profiles':      makeChecklist(true,  true, true,  true, true),
  'topbar-v2-display-modes': makeChecklist(true,  true, true,  true, true),
  'topbar-v2-side-panel':    makeChecklist(true,  true, true,  true, true),
  'topbar-v2-auto-pack':     makeChecklist(true,  true, true,  true, true),
  'entity-platform':         makeChecklist(false, true, true,  true, true),
  'entity-platform-p2':      makeChecklist(false, true, true,  true, true),
...
export const dataCcIds: DataCcIdEntry[] = [
  ...
  { ccId: 'settings.colorTheme', file: 'app/dashboard/settings/page.tsx', line: 345, textEditable: false, description: 'Color theme selector (Uncodixfy palettes)', descriptionHe: 'בורר ערכת צבעים' },
  ...
  { ccId: 'settings.density', file: 'app/dashboard/settings/page.tsx', line: 685, textEditable: false, description: 'UI density selector (_compact / default / spacious)', descriptionHe: 'בורר צפיפות (צפוף / ברירת מחדל / מרווח)' },
...
export const changelogEntries: ChangelogEntry[] = [
  ...
  },
  {
    ...
    purpose: 'The primary navigation for the dashboard. Each tab corresponds to a feature area (_Layers, Editor, Story Map, etc.). Float mode saves screen space for content-heavy pages. Links to / (Workspace Hub) via the logo.',
  ...
  },
  {
    ...
    notes: 'Manages: language (he/en), sidebar position (left/right), visibility mode, accent color (7 presets + custom hex), font family, border radius, density, brand profile (logo, tagline), glow effects. All persisted in localStorage (cc-* keys). Skin system removed — replaced by theme-store.',
    notesHe: 'מנהל: שפה (he/en), מיקום סיידבר (שמאל/ימין), מצב נראות, צבע מבטא (7 פריסטים + hex מותאם), משפחת גופנים, רדיוס גבול, צפיפות, פרופיל מותג (לוגו, סלוגן), אפקטי זוהר. נשמר ב-localStorage (מפתחות cc-*). מערכת סקינים הוסרה — הוחלפה ב-theme-store.',
  ...
  },
  {
    ...
    notes: 'Sections: Color themes (20 palettes), accent colors (7 presets + custom hex + saved palette), font family, border radius, density, sidebar position/visibility, brand profile (logo upload, company name, tagline), glow effects, style overrides editor.',
    notesHe: 'מקטעים: ערכות צבעים (20 פלטות), צבעי מבטא (7 פריסטים + hex מותאם + לוח שמור), משפחת גופנים, רדיוס גבול, צפיפות, מיקום/נראות סיידבר, פרופיל מותג (העלאת לוגו, שם חברה, סלוגן), אפקטי זוהר, עורך עקיפות סגנון.',
  ...
  },
  {
    ...
    feature: '5 placeholder pages (Functional Map, AI Hub, Architecture, Plan, Design System)',
    featureHe: '5 דפים ריקים (מפה פונקציונלית, מרכז AI, ארכיטקטורה, תוכנית, מערכת עיצוב)',
    status: 'working', commitStatus: 'committed', workflowStatus: 'todo',
    commitHash: '7c562f4', date: '2026-03-02', phase: 5,
    files: ['src/app/dashboard/functional-map/page.tsx', 'src/app/dashboard/ai-hub/page.tsx', 'src/app/dashboard/architecture/page.tsx', 'src/app/dashboard/plan/page.tsx', 'src/app/dashboard/design-system/page.tsx'],
  ...
  },
  {
    ...
    notes: 'n8n iframe for visual workflow builder. 3 automation types explained with code examples: DB Triggers (auto-_update timestamps, status change notifications), Edge Functions (Origami webhook sync, WATI WhatsApp), pg_cron (recurring tasks). Comparison table.',
  ...
  },
  {
    ...
    connectedTo: ['Sidebar (_Shield icon)', 'PageHeader', 'Workspace Hub (zone card link)'],
  },
  {
    id: 'video-prompt',
  ...
  {
    id: 'skins-system',
    feature: 'Skins system — DEPRECATED, replaced by theme system',
    featureHe: 'מערכת סקינים — הוסרה, הוחלפה במערכת תימות',
    status: 'broken', commitStatus: 'uncommitted', workflowStatus: 'complete',
    date: '2026-03-11',
    files: [],
    route: '/dashboard/settings',
    notes: 'Removed. skins.ts deleted, skin state/effects removed from SettingsContext, skin selector removed from Settings page. Replaced by theme-store (Zustand) + applyTheme() + ThemeSwitcher with 20 palettes.',
    notesHe: 'הוסרה. skins.ts נמחק, state/effects של skin הוסרו מ-SettingsContext, בורר סקינים הוסר מדף ההגדרות. הוחלפה ב-theme-store (Zustand) + applyTheme() + ThemeSwitcher עם 20 פלטות.',
    purpose: 'Deprecated — the theme system (theme-store + applyTheme + CSS bridge) provides a more comprehensive approach with 20 color palettes that control the entire Tailwind slate scale.',
    purposeHe: 'הוסרה — מערכת התימות (theme-store + applyTheme + CSS bridge) מספקת גישה מקיפה יותר עם 20 פלטות צבע ששולטות בכל סולם slate של Tailwind.',
    connectedTo: [],
  },
  {
    id: 'design-gallery',
  ...
  },
  {
    ...
    notes: 'Open redirect fix. Mermaid securityLevel strict. Link XSS prevention (sanitizeUrl). Command injection fix (execFileSync). Security headers (X-Frame-Options, _X-Content-Type-Options, Referrer-Policy, Permissions-Policy).',
...

  {
    ...
    workflowStatus: 'complete',
    date: '2026-03-07',
    files: ['src/app/dashboard/admin/page.tsx', 'src/app/dashboard/settings/page.tsx', 'src/app/dashboard/story-map/page.tsx', 'src/components/command-center/StoryMapFilterBar.tsx', 'src/app/dashboard/layers/page.tsx'],
    notes: 'Admin: stats grid 2→4→7 cols, phase label w-24/w-44, tab bar overflow-x-auto. Settings: color combos 2→3 cols, tab bar overflow. Story Map: px-4/px-6, flex-wrap selector, shrink-0 export. Filter bar: w-full/w-48 search. Layers: demo banner flex-wrap.',
    notesHe: 'אדמין: גריד סטטיסטיקות 2→4→7 עמודות, תווית שלב w-24/w-44, סרגל טאבים overflow. הגדרות: קומבו צבעים 2→3 עמודות. Story Map: ריפוד תגובתי, flex-wrap. Layers: banner flex-wrap.',
    ...
    connectedTo: ['admin', 'settings', 'story-map', 'StoryMapFilterBar', 'layers'],
  },
  ...
  {
    id: 'pwa-foundation',
    feature: 'PWA foundation — Serwist SW, manifest, push, offline, install prompt',
    featureHe: 'תשתית PWA — Serwist SW, מניפסט, התראות push, אופליין, הנחיית התקנה',
    status: 'working',
    commitStatus: 'committed',
    workflowStatus: 'complete',
    date: '2026-03-11',
    files: [
      ...
      'src/lib/pwa/usePushSubscription.ts',
      'src/lib/pwa/useInstallPrompt.ts',
      'src/lib/pwa/badge.ts',
      'src/lib/pwa/useDeviceCapabilities.ts',
      'src/lib/pwa/useCamera.ts',
      'src/lib/pwa/useContacts.ts',
      'src/lib/pwa/useWakeLock.ts',
      ...
      'supabase/migrations/20260370_push_preferences.sql',
      'src/lib/push/sendCommPush.ts',
    ],
    notes: 'Full PWA stack: Serwist service worker (precache, runtime caching, navigation preload, offline fallback), manifest.ts with maskable icons, push notification handlers (subscribe/unsubscribe/click), app badge via message event, install prompt hook, device capability hooks (camera, contacts, wake lock). Push subscriptions stored in Supabase (push_subscriptions table with RLS, preferences JSONB column for per-channel opt-out). Settings page includes PWA tab. Offline page at /~offline. sendCommPush helper sends push notifications when new comm_messages arrive (WATI/Voicenter webhooks) — respects user preferences. notification_log table tracks all sent notifications. API: /api/push/preferences (GET/PUT) for managing per-channel toggles.',
    ...
    connectedTo: ['layout.tsx', 'manifest.ts', 'sw.ts', 'settings/page.tsx', 'api/push/subscribe'],
  },
  {
    id: 'ux-bugfix-pass',
  ...
  {
    id: 'self-audit-fixes',
    feature: 'Self-audit fixes — hooks order, dead route, unused imports, memo, a11y',
    featureHe: 'תיקוני ביקורת עצמית — סדר hooks, ניתוב מת, ייבואים מיותרים, memo, נגישות',
    status: 'working',
    commitStatus: 'committed',
    workflowStatus: 'complete',
    commitHash: '7d3f127',
    date: '2026-03-07',
    files: [
      'src/components/command-center/widgets/TimerWidget.tsx',
      'src/components/command-center/widgets/WeeklyPlannerWidget.tsx',
      'src/components/command-center/widgets/WidgetWrapper.tsx',
      'src/components/command-center/widgets/NotificationsWidget.tsx',
      'src/components/command-center/TopBar.tsx',
      'src/app/dashboard/automations/page.tsx',
      'src/app/dashboard/admin/page.tsx',
    ],
    notes: 'Automated self-audit found 8 issues: (1) TimerWidget hooks called after early return — moved hooks above return, (2) WeeklyPlannerWidget same hooks-after-return fix, (3) WidgetWrapper dead code removed (activeWidgets import), (4) NotificationsWidget unused import removed, (5) TopBar unused setError removed, (6) Automations page missing key prop on mapped elements, (7) Admin page React.memo on 3 heavy sub-components (ChangelogTab, RoutesTab, ChecklistPanel), (8) Various button type="button" additions.',
    notesHe: 'ביקורת עצמית אוטומטית מצאה 8 בעיות: (1-2) hooks שנקראו אחרי return מוקדם ב-TimerWidget ו-WeeklyPlannerWidget, (3-5) קוד מת וייבואים מיותרים, (6) key חסר על אלמנטים ממופים, (7) React.memo על 3 קומפוננטות כבדות, (8) הוספת type="button".',
    purpose: 'Code quality sweep — fix React hooks rules violations (hooks after early return), remove dead imports and unused state, add missing key props, optimize renders with React.memo on heavy admin sub-components.',
    purposeHe: 'מעבר איכות קוד — תיקון הפרות חוקי React hooks, הסרת ייבואים מתים, הוספת key חסרים, אופטימיזציה עם React.memo.',
    connectedTo: ['TimerWidget.tsx', 'WeeklyPlannerWidget.tsx', 'WidgetWrapper.tsx', 'NotificationsWidget.tsx', 'TopBar.tsx', 'admin/page.tsx'],
  },
  {
    id: 'aria-labels-pass',
    feature: 'Aria-labels on ~35 icon-only buttons across 15 widget files',
    featureHe: 'Aria-labels על ~35 כפתורי אייקון בלבד ב-15 קבצי ווידג\'טים',
    status: 'working',
    commitStatus: 'committed',
    workflowStatus: 'complete',
    commitHash: '9575af1',
    ...
    files: [
      ...
      'src/components/command-center/widgets/AIWidget.tsx',
      'src/components/command-center/widgets/QuickCreateWidget.tsx',
      'src/components/command-center/widgets/FavoritesWidget.tsx',
      'src/components/command-center/widgets/TodayWidget.tsx',
      'src/components/command-center/widgets/NotificationsWidget.tsx',
      'src/components/command-center/widgets/TimerWidget.tsx',
      'src/components/command-center/widgets/ClipboardWidget.tsx',
      'src/components/command-center/widgets/SettingsWidget.tsx',
      'src/components/command-center/widgets/ShortcutsWidget.tsx',
      'src/components/command-center/widgets/WeeklyPlannerWidget.tsx',
      'src/components/command-center/widgets/WidgetWrapper.tsx',
      'src/components/command-center/widgets/FolderItemCell.tsx',
      'src/components/command-center/widgets/FolderCreator.tsx',
      'src/components/command-center/widgets/AppsDrawer.tsx',
    ],
    notes: 'Added aria-label to ~35 icon-only buttons and interactive elements across all 15 widget files. Every button with only an icon (no visible text) now has a descriptive aria-label in both Hebrew and English (_context-appropriate). Improves screen reader experience.',
    notesHe: 'הוספת aria-label ל-~35 כפתורים ואלמנטים אינטראקטיביים עם אייקון בלבד ב-15 קבצי ווידג\'טים. כל כפתור עם אייקון בלבד מקבל תיאור נגיש בעברית ובאנגלית.',
    purpose: 'Screen reader accessibility — every icon-only button in the widget system now has a descriptive aria-label, enabling assistive technology users to understand interactive elements.',
    purposeHe: 'נגישות קורא מסך — כל כפתור אייקון-בלבד במערכת הווידג\'טים מקבל aria-label תיאורי.',
    connectedTo: ['SearchWidget.tsx', 'AIWidget.tsx', 'QuickCreateWidget.tsx', 'FavoritesWidget.tsx', 'TodayWidget.tsx', 'NotificationsWidget.tsx', 'TimerWidget.tsx', 'ClipboardWidget.tsx', 'SettingsWidget.tsx', 'ShortcutsWidget.tsx', 'WeeklyPlannerWidget.tsx', 'WidgetWrapper.tsx'],
  },
  {
    id: 'data-cc-id-pass',
    feature: 'data-cc-id attributes + registry entries + missing checklists',
    featureHe: 'תגיות data-cc-id + רישום ברגיסטרי + צ\'קליסטים חסרים',
    status: 'working',
    commitStatus: 'committed',
    workflowStatus: 'complete',
    commitHash: '52faddc',
    ...
    files: [
      'src/app/dashboard/settings/page.tsx',
      'src/app/dashboard/automations/page.tsx',
      'src/app/dashboard/layers/page.tsx',
      'src/app/dashboard/admin/data.ts',
      'src/app/dashboard/admin/page.tsx',
    ],
    notes: 'Three-part pass: (1) Added 28 data-cc-id attributes across settings (21), automations (4), layers (3) pages — modified Section component to accept ccId prop. (2) Registered 30 entries in dataCcIds registry with bilingual descriptions. (3) Added 11 missing CHANGELOG_CHECKLISTS entries for all dashboard pages.',
    notesHe: 'מעבר תלת-חלקי: (1) הוספת 28 תגיות data-cc-id בדפי הגדרות (21), אוטומציות (4), שכבות (3). (2) רישום 30 ערכים ברגיסטרי dataCcIds. (3) הוספת 11 רשומות CHANGELOG_CHECKLISTS חסרות.',
    purpose: 'Complete the Guide/Style Override system coverage: every interactive section in settings, automations, and layers now has a data-cc-id for the admin registry. Registry fully synced. All changelog entries now have checklists.',
    purposeHe: 'השלמת כיסוי מערכת המדריך/עקיפת סגנון: כל סקציה אינטראקטיבית מקבלת data-cc-id. הרגיסטרי מסונכרן. כל רשומות ה-changelog מקבלות צ\'קליסט.',
    connectedTo: ['settings/page.tsx', 'automations/page.tsx', 'layers/page.tsx', 'admin/data.ts', 'admin/page.tsx'],
  },
  {
    id: 'editor-save-fix',
    feature: 'Editor save — last_edited_at, ⌘S display, triple-save race fix',
    featureHe: 'תיקון שמירת עורך — last_edited_at, תצוגת ⌘S, מניעת שמירה משולשת',
    status: 'working',
    commitStatus: 'committed',
    workflowStatus: 'complete',
    commitHash: '0424ed4',
    ...
    notes: 'Four fixes: (1) handleSave now updates last_edited_at so document list reflects recent edits. (2) Status bar shows ⌘S on Mac instead of hardcoded Ctrl+S. (3) Removed stale-closure ProseMirror keydown handler that caused triple-save race condition — TiptapEditor React onKeyDown + CanvasEditor window handler were enough. (4) Save error now persists until next successful save (was auto-clearing after 3s).',
    notesHe: 'ארבעה תיקונים: (1) handleSave מעדכן last_edited_at כדי שרשימת המסמכים תשקף עריכות. (2) סרגל סטטוס מציג ⌘S ב-Mac. (3) הסרת handler ProseMirror עם stale closure שגרם למרוץ שמירה משולש. (4) שגיאת שמירה נשארת עד שמירה מוצלחת.',
    purpose: 'Fix editor save bugs: documents were not appearing as recently edited because last_edited_at was not updated; keyboard shortcut hint showed wrong key on Mac; three concurrent save handlers caused race conditions; save errors disappeared silently.',
    purposeHe: 'תיקון באגי שמירה בעורך: מסמכים לא הופיעו כנערכים לאחרונה, קיצור מקלדת הציג מקש שגוי ב-Mac, שלושה handlers של שמירה גרמו למרוצים, שגיאות שמירה נעלמו בשקט.',
    connectedTo: ['CanvasEditor.tsx', 'TiptapEditor.tsx', 'EditorZone.tsx'],
  },
  {
    id: 'editor-resilience',
    feature: 'Editor resilience — auto-save with retry, offline queue, enhanced status',
    featureHe: 'עמידות עורך — שמירה אוטומטית עם ניסיון חוזר, תור אופליין, סטטוס משופר',
    status: 'working',
    commitStatus: 'committed',
    workflowStatus: 'complete',
    commitHash: '466eab7',
    date: '2026-03-07',
    files: [
      'src/lib/editor/useAutoSave.ts',
      'src/lib/editor/offlineQueue.ts',
      'src/components/canvas/CanvasEditor.tsx',
      'src/components/canvas/CanvasToolbar.tsx',
      'src/components/canvas/EditorZone.tsx',
      'src/components/editor/TiptapEditor.tsx',
    ...
    notes: 'useAutoSave hook: 1s debounce, 3x retry with exponential backoff (1s/2s/4s), IndexedDB offline queue for failed saves. Auto-flushes offline queue on reconnect. StatusBar shows 5 states: saving (blue), saved (green), retrying (amber), error (red), offline (orange). beforeunload warning prevents leaving during save.',
    notesHe: 'hook של useAutoSave: דיבאונס 1 שנייה, 3 ניסיונות חוזרים עם backoff מעריכי. תור IndexedDB לשמירות שנכשלו. שטיפה אוטומטית בחזרה לאונליין. סרגל סטטוס עם 5 מצבים. אזהרת beforeunload.',
    purpose: 'Make the editor save flow bulletproof: retry on failure, save locally when offline, flush when reconnected. No more silent save failures.',
    purposeHe: 'הפיכת זרימת השמירה של העורך לחסינת תקלות: ניסיון חוזר בכשל, שמירה מקומית באופליין, שטיפה בחיבור מחדש.',
    connectedTo: ['useAutoSave.ts', 'offlineQueue.ts', 'CanvasEditor.tsx', 'TiptapEditor.tsx', 'EditorZone.tsx', 'CanvasToolbar.tsx'],
  },
  {
    id: 'health-monitoring',
    feature: 'Health endpoint + pgTAP RLS tests',
    featureHe: 'נקודת קצה בריאות + בדיקות pgTAP RLS',
    status: 'working',
    commitStatus: 'committed',
    workflowStatus: 'complete',
    commitHash: 'b285295',
    ...
    files: [
      ...
      'supabase/tests/database/000-helpers.test.sql',
      'supabase/tests/database/001-rls-vb-records.test.sql',
      'supabase/tests/database/002-rls-projects.test.sql',
    ],
    notes: 'GET /api/health — 4 checks: DB connectivity (service role query), Auth service, RLS enforcement (anon should be blocked), write cycle (insert+_update+delete). pgTAP tests verify RLS enabled on tables + schema columns.',
    notesHe: 'GET /api/health — 4 בדיקות: חיבור DB, שירות Auth, אכיפת RLS, מחזור כתיבה. בדיקות pgTAP מוודאות RLS פעיל וסכמת עמודות.',
    purpose: 'Automated health monitoring: API endpoint for uptime checks, pgTAP tests for RLS policy verification after migrations.',
    purposeHe: 'ניטור בריאות אוטומטי: נקודת קצה API לבדיקות זמינות, בדיקות pgTAP לאימות פוליסות RLS אחרי מיגרציות.',
    connectedTo: ['health/route.ts', 'supabase/tests/'],
  },
  {
    id: 'ci-testing-pipeline',
    feature: 'CI pipeline — TypeScript, pgTAP, Playwright E2E',
    featureHe: 'צינור CI — TypeScript, pgTAP, בדיקות E2E Playwright',
    status: 'working',
    commitStatus: 'committed',
    workflowStatus: 'complete',
    commitHash: 'b285295',
    ...
    notes: 'GitHub Actions CI with 3 jobs: (1) TypeScript typecheck, (2) pgTAP database tests via Supabase CLI, (3) Playwright E2E tests. Playwright tests: health endpoint, editor navigation, document creation + typing + autosave (with auth).',
    notesHe: 'GitHub Actions CI עם 3 משימות: (1) בדיקת TypeScript, (2) בדיקות pgTAP דרך Supabase CLI, (3) בדיקות Playwright E2E. בדיקות: בריאות, ניווט עורך, יצירה + הקלדה + שמירה אוטומטית.',
    purpose: 'Automated CI pipeline: every push/PR runs typecheck, database tests, and E2E tests. Prevents regressions from reaching production.',
    purposeHe: 'צינור CI אוטומטי: כל push/PR מריץ בדיקת TypeScript, בדיקות DB ובדיקות E2E. מונע רגרסיות מלהגיע לייצור.',
    connectedTo: ['ci.yml', 'playwright.config.ts', 'e2e/'],
  },

  // ── Phase: Senior Architect Audit — P0 ── 2026-03-07

  {
    id: 'api-auth-hardening',
    feature: 'Add Supabase auth to all API routes',
    featureHe: 'הוספת אימות Supabase לכל ה-API routes',
    status: 'working',
    commitStatus: 'committed',
    workflowStatus: 'complete',
    date: '2026-03-07',
    files: [
      'src/lib/api/auth.ts',
      'src/app/api/ai/chat/route.ts',
      'src/app/api/origami/sync/route.ts',
      'src/app/api/embeddings/generate/route.ts',
      'src/app/api/embeddings/search/route.ts',
      'src/app/api/health/route.ts',
    ],
    notes: 'Create requireAuth() helper that verifies JWT via Supabase getUser(). Add to all API routes. AI chat currently trusts client-sent userId header — no JWT validation. Origami sync, embeddings have zero auth. Health endpoint leaks RLS status and does unauthenticated write cycles.',
    notesHe: 'יצירת helper requireAuth() שמאמת JWT דרך Supabase getUser(). להוסיף לכל ה-API routes. AI chat כרגע סומך על userId מה-header — בלי אימות JWT. Origami sync, embeddings בלי auth בכלל. Health endpoint חושף סטטוס RLS ועושה write cycles בלי אימות.',
    purpose: 'CRITICAL SECURITY: All API routes are publicly accessible. Anyone on the internet can call /api/ai/chat (costs money), /api/origami/sync (triggers data sync), /api/embeddings/generate (costs money). The AI chat auth is fake — it reads the Authorization header as a raw string, no JWT verification.',
    purposeHe: 'אבטחה קריטית: כל ה-API routes נגישים לכולם. כל אחד באינטרנט יכול לקרוא ל-/api/ai/chat (עולה כסף), /api/origami/sync (מפעיל סנכרון), /api/embeddings/generate (עולה כסף). האימות ב-AI chat מזויף — קורא את ה-header כמחרוזת בלי אימות JWT.',
    connectedTo: ['supabase/middleware.ts', 'ai-hub', 'origami-sync'],
  },
  {
    id: 'sentry-error-tracking',
    feature: 'Add Sentry error tracking',
    featureHe: 'הוספת Sentry למעקב שגיאות',
    status: 'not-verified',
    commitStatus: 'uncommitted',
    workflowStatus: 'todo',
    date: '2026-03-07',
    ...
    notes: 'Install @sentry/nextjs, configure client+server, wrap next.config with withSentryConfig. Replace console.error in error boundaries with Sentry.captureException. Add to useAutoSave for save failure tracking. Currently errors vanish into void — no way to know something broke until a user complains.',
    notesHe: 'להתקין @sentry/nextjs, להגדיר client+server, לעטוף next.config עם withSentryConfig. להחליף console.error ב-error boundaries ב-Sentry.captureException. להוסיף ל-useAutoSave למעקב כשלונות שמירה. כרגע שגיאות נעלמות — אין דרך לדעת שמשהו נשבר.',
    purpose: 'ZERO OBSERVABILITY: Error boundaries exist but only console.error. In production, errors are invisible. No way to detect save failures, API errors, or client crashes. Sentry gives alerts, stack traces, user impact data.',
    purposeHe: 'אפס תצפיתיות: Error boundaries קיימים אבל רק console.error. בייצור שגיאות בלתי נראות. אין דרך לזהות כשלונות שמירה, שגיאות API או קריסות. Sentry נותן התראות, stack traces, נתוני השפעה על משתמשים.',
    connectedTo: ['error.tsx', 'useAutoSave.ts'],
  },
  {
    id: 'zod-input-validation',
    feature: 'Add zod input validation to all API routes',
    featureHe: 'הוספת ולידציית zod לכל ה-API routes',
    status: 'working',
    commitStatus: 'committed',
    workflowStatus: 'complete',
    date: '2026-03-07',
    ...
    notes: 'Install zod, create schemas for each endpoint. AI chat: validate messages array (block role:"system"), limit content length. Embeddings: validate documentId/batch. Currently all validation is hand-written typeof checks — attacker can send role:"system" to inject prompt.',
    notesHe: 'להתקין zod, ליצור schemas לכל endpoint. AI chat: לוודא מערך הודעות (לחסום role:"system"), להגביל אורך. Embeddings: לוודא documentId/batch. כרגע כל הוולידציה ידנית עם typeof — תוקף יכול לשלוח role:"system" ולהזריק prompt.',
    purpose: 'NO INPUT VALIDATION: No zod, ajv, yup, or joi. Each API route does ad-hoc typeof checks. AI chat accepts arbitrary message roles including "system" — prompt injection vector. Embeddings batch mode is unbounded compute.',
    purposeHe: 'אין ולידציית קלט: אין zod, ajv, yup או joi. כל route עושה בדיקות typeof אד-הוק. AI chat מקבל כל role כולל "system" — וקטור הזרקת prompt. מצב batch ב-embeddings הוא חישוב בלתי מוגבל.',
    connectedTo: ['api-auth-hardening'],
  },
  {
    id: 'unit-tests-editor',
    feature: 'Unit tests for useAutoSave + offlineQueue',
    featureHe: 'בדיקות יחידה ל-useAutoSave + offlineQueue',
    status: 'working',
    commitStatus: 'committed',
    workflowStatus: 'complete',
    date: '2026-03-07',
    files: [
      'vitest.config.ts',
      'src/lib/editor/__tests__/useAutoSave.test.ts',
      'src/lib/editor/__tests__/offlineQueue.test.ts',
    ],
    notes: 'Install vitest + @testing-library/react. Test useAutoSave: successful save, retry on failure (3x with backoff), offline fallback, RLS detection (0 rows). Test offlineQueue: save/retrieve, dedup by documentId, flush stops on failure, IndexedDB unavailable gracefully. Currently 0% test coverage on the most critical code.',
    notesHe: 'להתקין vitest + @testing-library/react. לבדוק useAutoSave: שמירה מוצלחת, retry בכשלון (3 פעמים עם backoff), fallback אופליין, זיהוי RLS (0 שורות). לבדוק offlineQueue: שמירה/שליפה, dedup לפי documentId, flush עוצר בכשלון, IndexedDB לא זמין. כרגע 0% כיסוי על הקוד הכי קריטי.',
    purpose: 'ZERO UNIT TESTS: The most critical code in the system (autosave with retry, exponential backoff, IndexedDB offline queue) has 0 tests. Any change to save logic could silently break and lose user data with no safety net.',
    purposeHe: 'אפס בדיקות יחידה: הקוד הכי קריטי במערכת (שמירה אוטומטית עם retry, backoff, תור אופליין IndexedDB) ללא בדיקות. כל שינוי בלוגיקת שמירה יכול לשבור בשקט ולאבד מידע בלי רשת ביטחון.',
    connectedTo: ['useAutoSave.ts', 'offlineQueue.ts'],
  },

  // ── Phase: Senior Architect Audit — P1 ── 2026-03-07

  {
    id: 'fix-e2e-tests',
    feature: 'Fix E2E tests — remove conditional assertions',
    featureHe: 'תיקון בדיקות E2E — הסרת assertions מותנים',
    status: 'working',
    commitStatus: 'committed',
    workflowStatus: 'complete',
    date: '2026-03-07',
    ...
    notes: 'Current tests wrap assertions in if(isVisible) — if element not found, test passes with zero assertions (false positive). Remove all conditionals, replace waitForTimeout with waitForSelector, add real auth test. Tests should FAIL when things break.',
    notesHe: 'הבדיקות הנוכחיות עוטפות assertions ב-if(isVisible) — אם האלמנט לא נמצא, הבדיקה עוברת ללא בדיקה (false positive). להסיר כל התניות, להחליף waitForTimeout ב-waitForSelector, להוסיף בדיקת auth אמיתית.',
    purpose: 'FALSE POSITIVE TESTS: E2E tests pass even when the editor is completely broken because assertions are wrapped in if(isVisible). This gives false confidence — the CI shows green while real functionality is broken.',
    purposeHe: 'בדיקות false positive: בדיקות E2E עוברות גם כשהעורך שבור לחלוטין כי ה-assertions עטופים ב-if(isVisible). זה נותן ביטחון שווא — ה-CI מראה ירוק בזמן שפונקציונליות אמיתית שבורה.',
    connectedTo: ['ci-testing-pipeline', 'playwright.config.ts'],
  },
  {
    id: 'remove-puppeteer',
    feature: 'Remove unused puppeteer dependency (350MB)',
    featureHe: 'הסרת puppeteer שלא בשימוש (350MB)',
    status: 'working',
    commitStatus: 'committed',
    workflowStatus: 'complete',
    date: '2026-03-07',
    files: ['package.json'],
    notes: 'puppeteer (^24.38.0) is in dependencies but imported exactly 0 times in any source file. Downloads full Chromium binary — adds ~350MB to node_modules, inflates install time, increases security attack surface.',
    notesHe: 'puppeteer (^24.38.0) ב-dependencies אבל לא מיובא אף פעם. מוריד Chromium מלא — מוסיף ~350MB ל-node_modules, מנפח זמן התקנה, מגדיל שטח תקיפה.',
    purpose: 'BLOAT: 350MB unused dependency. Never imported anywhere. Slows CI install, increases attack surface, wastes disk space. The audit system already flagged this but nobody acted.',
    purposeHe: 'ניפוח: דפנדנסי של 350MB לא בשימוש. לא מיובא בשום מקום. מאט התקנת CI, מגדיל שטח תקיפה, מבזבז דיסק.',
  },
  {
    id: 'optimistic-locking',
    feature: 'Add optimistic locking for concurrent document editing',
    featureHe: 'הוספת optimistic locking לעריכת מסמכים במקביל',
    status: 'working',
    commitStatus: 'committed',
    workflowStatus: 'complete',
    date: '2026-03-07',
    ...
    notes: 'Two tabs editing same document = last write wins, silently. Add .eq("last_edited_at", lastKnown) to UPDATE query — if 0 rows returned, show conflict dialog. Currently no version check, no timestamp comparison, no user notification.',
    notesHe: 'שני טאבים על אותו מסמך = האחרון שכותב מנצח, בשקט. להוסיף .eq("last_edited_at", lastKnown) לשאילתת UPDATE — אם 0 שורות, להציג דיאלוג conflict. כרגע אין בדיקת גרסה, אין השוואת timestamp, אין הודעה למשתמש.',
    purpose: 'DATA LOSS RISK: No conflict resolution. Two tabs open on same document — both auto-save independently with blind UPDATE. Last write wins, overwriting the other tab\'s changes silently. User loses work without knowing.',
    purposeHe: 'סיכון לאיבוד מידע: אין פתרון conflictsים. שני טאבים על אותו מסמך — שניהם שומרים בנפרד עם UPDATE עיוור. האחרון שכותב מנצח ודורס את השינויים של הטאב השני בשקט.',
    connectedTo: ['useAutoSave.ts', 'editor-resilience'],
  },
  {
    id: 'real-rls-tests',
    feature: 'Write real pgTAP RLS tests (not just schema checks)',
    featureHe: 'כתיבת בדיקות RLS אמיתיות ב-pgTAP (לא רק בדיקות schema)',
    status: 'working',
    commitStatus: 'committed',
    workflowStatus: 'complete',
    date: '2026-03-07',
    files: [
      'supabase/tests/database/001-rls-vb-records.test.sql',
      'supabase/tests/database/002-rls-projects.test.sql',
      'supabase/tests/database/003-rls-story-cards.test.sql',
    ],
    notes: 'Current tests verify columns exist — NOT that RLS blocks access. Rewrite: SET ROLE anon → verify SELECT returns 0 rows, INSERT throws. SET ROLE authenticated → verify CRUD works. Test cross-user isolation.',
    notesHe: 'הבדיקות הנוכחיות מוודאות שעמודות קיימות — לא ש-RLS חוסם גישה. לשכתב: SET ROLE anon → לוודא SELECT מחזיר 0 שורות, INSERT נכשל. SET ROLE authenticated → לוודא CRUD עובד. לבדוק בידוד בין משתמשים.',
    purpose: 'FALSE SECURITY: RLS tests titled "RLS policies" but only check column existence. No test that anonymous users are blocked, no test that user A can\'t read user B\'s data. Gives false confidence about security.',
    purposeHe: 'ביטחון שווא: בדיקות RLS בשם "RLS policies" אבל רק בודקות שעמודות קיימות. אין בדיקה שמשתמשים אנונימיים חסומים, אין בדיקה שמשתמש A לא יכול לקרוא את המידע של משתמש B.',
    connectedTo: ['health-monitoring', 'rls-authenticated'],
  },

  // ── Phase: Senior Architect Audit — P2 ── 2026-03-07

  {
    id: 'code-splitting',
    feature: 'Add code splitting with next/dynamic',
    featureHe: 'הוספת code splitting עם next/dynamic',
    status: 'working',
    commitStatus: 'committed',
    workflowStatus: 'complete',
    date: '2026-03-07',
    files: [
      'src/components/command-center/widgets/WidgetRegistry.ts',
      'src/app/dashboard/editor/page.tsx',
      'src/app/dashboard/story-map/page.tsx',
    ],
    notes: 'Zero lazy loading in entire codebase — no next/dynamic or React.lazy. All 11 widgets, Tiptap editor, dnd-kit loaded on every page (~300-500KB unnecessary). Use next/dynamic with ssr:false for widget components and heavy page components.',
    notesHe: 'אפס lazy loading בכל הקוד — אין next/dynamic או React.lazy. כל 11 הווידג\'טים, עורך Tiptap, dnd-kit נטענים בכל דף (~300-500KB מיותרים). להשתמש ב-next/dynamic עם ssr:false לקומפוננטות כבדות.',
    purpose: 'PERFORMANCE: Every page loads all widgets, the full Tiptap editor, and dnd-kit — even if user never opens them. ~300-500KB of unnecessary JS on every page load. Hurts mobile FCP significantly.',
    purposeHe: 'ביצועים: כל דף טוען את כל הווידג\'טים, עורך Tiptap המלא ו-dnd-kit — גם אם המשתמש אף פעם לא פותח אותם. ~300-500KB של JS מיותר בכל טעינת דף.',
    connectedTo: ['WidgetRegistry.ts', 'CanvasEditor.tsx'],
  },
  {
    id: 'consolidate-types',
    feature: 'Clean up dead schema.ts and consolidate duplicate types',
    featureHe: 'ניקוי schema.ts מת ואיחוד טיפוסים כפולים',
    status: 'working',
    commitStatus: 'committed',
    workflowStatus: 'complete',
    date: '2026-03-07',
    ...
    notes: 'schema.ts (174 lines) is dead code — zero imports. DocRecord, DocTemplate, DocVersion, DocShare defined twice (schema.ts + editorQueries.ts). SaveState type duplicated inline in 4 files. Either delete schema.ts or make it the single source of truth and import from it.',
    notesHe: 'schema.ts (174 שורות) = קוד מת — אפס imports. DocRecord, DocTemplate, DocVersion, DocShare מוגדרים פעמיים (schema.ts + editorQueries.ts). SaveState משוכפל inline ב-4 קבצים. למחוק schema.ts או להפוך אותו למקור אמת יחיד.',
    purpose: 'MAINTENANCE DEBT: Duplicate type definitions guarantee schema drift over time. Changes to one location won\'t reflect in the other. Dead code creates confusion about which types are canonical.',
    purposeHe: 'חוב תחזוקה: הגדרות טיפוסים כפולות מבטיחות drift לאורך זמן. שינויים במקום אחד לא ישתקפו במקום השני. קוד מת יוצר בלבול לגבי מה הטיפוסים הקנוניים.',
    connectedTo: ['editorQueries.ts', 'useAutoSave.ts'],
  },
  {
    id: 'remove-fallback-uuids',
    feature: 'Remove hardcoded fallback UUIDs from editorQueries',
    featureHe: 'הסרת UUID fallbacks hardcoded מ-editorQueries',
    status: 'working',
    commitStatus: 'committed',
    workflowStatus: 'complete',
    date: '2026-03-07',
    files: ['src/lib/supabase/editorQueries.ts'],
    notes: 'editorQueries.ts uses hardcoded UUIDs as fallback: created_by = "a0000000-...", workspace_id = "3ecaf990-...". If user not authenticated, documents created with fake IDs. Should throw error instead of silently creating bad data.',
    notesHe: 'editorQueries.ts משתמש ב-UUIDs hardcoded כ-fallback: created_by = "a0000000-...", workspace_id = "3ecaf990-...". אם המשתמש לא מחובר, מסמכים נוצרים עם IDs מזויפים. צריך לזרוק שגיאה במקום ליצור מידע שגוי בשקט.',
    purpose: 'DATA INTEGRITY: Documents created without auth get fake user IDs that don\'t match any real user. Creates orphaned records, breaks ownership queries, makes RLS useless for those records.',
    purposeHe: 'שלמות מידע: מסמכים שנוצרים בלי auth מקבלים IDs מזויפים שלא מתאימים למשתמש אמיתי. יוצר רשומות יתומות, שובר שאילתות בעלות, הופך RLS לחסר תועלת.',
    connectedTo: ['api-auth-hardening', 'editor-resilience'],
  },
  {
    id: 'scope-providers-widget-boundaries',
    feature: 'Scope WeeklyPlannerProvider + add per-widget error boundaries',
    featureHe: 'צמצום WeeklyPlannerProvider + error boundaries לווידג\'טים',
    status: 'working',
    commitStatus: 'committed',
    workflowStatus: 'complete',
    date: '2026-03-07',
    ...
    notes: 'WeeklyPlannerProvider wraps the entire dashboard but only used by one widget — causes unnecessary re-renders. Move it inside WeeklyPlannerWidget. Also: if any widget throws, the entire dashboard crashes. Add WidgetErrorBoundary in WidgetWrapper so broken widgets show error state without taking down the page.',
    notesHe: 'WeeklyPlannerProvider עוטף את כל הדשבורד אבל משמש רק ווידג\'ט אחד — גורם ל-re-renders מיותרים. להעביר לתוך WeeklyPlannerWidget. גם: אם ווידג\'ט קורס, כל הדשבורד נופל. להוסיף WidgetErrorBoundary ב-WidgetWrapper כדי שווידג\'ט שבור יציג שגיאה בלי להפיל את הדף.',
  ...
  {
    id: 'kpi-widget',
    feature: 'KPI widget — quick metrics from Supabase (projects, documents, health)',
    featureHe: 'ווידג\'ט מדדים — מטריקות מהירות מ-Supabase (פרויקטים, מסמכים, בריאות)',
    status: 'working',
    commitStatus: 'committed',
    workflowStatus: 'complete',
    date: '2026-03-08',
    phase: 5,
    files: ['src/components/command-center/widgets/KPIWidget.tsx', 'src/components/command-center/widgets/WidgetRegistry.ts'],
    route: '/dashboard',
    notes: '4 metric cards: active projects, documents, 7-day activity, avg health score. Fetches from Supabase (projects + vb_records). Color-coded health indicator. Refresh button.',
    notesHe: '4 כרטיסי מטריקה: פרויקטים פעילים, מסמכים, פעילות 7 ימים, בריאות ממוצעת. שואב מ-Supabase. אינדיקטור בריאות צבעוני. כפתור רענון.',
    purpose: 'Provides at-a-glance KPI metrics directly in the top bar widget system. Activated from coming-soon to active.',
    purposeHe: 'מספק מדדי KPI במבט אחד ישירות ממערכת הווידג\'טים בסרגל העליון. הועבר ממצב coming-soon לפעיל.',
    connectedTo: ['WidgetRegistry.ts', 'supabaseClient.ts', 'WidgetStore.tsx'],
  },
  {
    id: 'shortcuts-widget',
    feature: 'External Links widget — quick links to Origami, Notion, n8n, Vercel, GitHub, WATI',
    featureHe: 'ווידג\'ט קיצורים — לינקים מהירים ל-Origami, Notion, n8n, Vercel, GitHub, WATI',
    status: 'working',
    commitStatus: 'committed',
    workflowStatus: 'complete',
    date: '2026-03-08',
    phase: 5,
    files: ['src/components/command-center/widgets/ExternalLinksWidget.tsx', 'src/components/command-center/widgets/WidgetRegistry.ts'],
    route: '/dashboard',
    notes: '6 default links with emoji icons. Add custom links with emoji + label + URL. Persisted in localStorage (cc-external-links). Reset to defaults option.',
    notesHe: '6 לינקים ברירת מחדל עם אימוג\'י. הוספת לינקים מותאמים אישית. נשמר ב-localStorage. אפשרות איפוס.',
    purpose: 'Provides one-click access to all external tools used by GAM team. Activated from coming-soon to active. Custom links persist in localStorage.',
    purposeHe: 'מספק גישה בלחיצה אחת לכל הכלים החיצוניים של צוות GAM. הועבר ממצב coming-soon לפעיל. לינקים מותאמים נשמרים ב-localStorage.',
    connectedTo: ['WidgetRegistry.ts', 'WidgetStore.tsx'],
  },
  {
    id: 'layers-filters',
    feature: 'Layers page — search, status/layer filters, sort',
    featureHe: 'עמוד שכבות — חיפוש, סינון לפי סטטוס/שכבה, מיון',
    status: 'working',
    commitStatus: 'committed',
    workflowStatus: 'complete',
    date: '2026-03-08',
    phase: 1,
    files: ['src/app/dashboard/layers/page.tsx', 'src/lib/i18n.ts'],
    route: '/dashboard/layers',
    notes: 'Search by project name. Status filter pills (All/Active/Completed/On Hold). Layer filter (All/Product/Infrastructure/Client). Sort by health/name/updated. Unified sync button. Empty state. i18n in he/en/ru.',
    notesHe: 'חיפוש לפי שם פרויקט. כפתורי סינון סטטוס. סינון שכבה. מיון לפי בריאות/שם/עדכון. כפתור סנכרון אחיד. מצב ריק. i18n ב-he/en/ru.',
    purpose: 'Makes the Layers project list actually usable at scale — users can find, filter, and sort projects instead of scrolling through an unordered list.',
    purposeHe: 'הופך את רשימת הפרויקטים בשכבות לשימושית בקנה מידה — משתמשים יכולים לחפש, לסנן ולמיין פרויקטים.',
    connectedTo: ['ProjectCard.tsx', 'HealthBadge.tsx', 'i18n.ts'],
  },
  {
    id: 'notifications-supabase',
    feature: 'Notifications — Supabase persistence + server validation',
    featureHe: 'התראות — שמירה ב-Supabase + ולידציה בשרת',
    status: 'working',
    commitStatus: 'committed',
    workflowStatus: 'complete',
    date: '2026-03-08',
    phase: 5,
    files: ['src/app/api/notifications/route.ts', 'src/components/command-center/widgets/NotificationsWidget.tsx'],
    route: '/dashboard',
    notes: 'API route with requireAuth + Zod validation. Hybrid: localStorage for instant, Supabase for persistence. Merge on mount. Mark read syncs to server. POST/PATCH validated with Zod schemas.',
    notesHe: 'נתיב API עם requireAuth + ולידציית Zod. היברידי: localStorage למיידי, Supabase לשמירה. מיזוג בטעינה. סימון כנקרא מסונכרן לשרת.',
    purpose: 'Notifications now persist across sessions via Supabase. API route follows established auth + validation patterns (requireAuth, Zod). Hybrid local/server approach ensures instant UX.',
    purposeHe: 'ההתראות נשמרות עכשיו בין סשנים דרך Supabase. נתיב API עוקב אחרי דפוסים מבוססים (requireAuth, Zod). גישה היברידית local/server מבטיחה UX מיידי.',
    connectedTo: ['NotificationsWidget.tsx', 'api/notifications/route.ts', 'lib/api/auth.ts', 'lib/api/schemas.ts'],
  },
  {
    id: 'dashboard-home',
    feature: 'Dashboard home page — overview with stat cards, recent projects, events, quick actions',
    featureHe: 'עמוד בית דשבורד — סקירה כללית עם כרטיסי מטריקה, פרויקטים אחרונים, אירועים, פעולות מהירות',
    status: 'working',
    commitStatus: 'committed',
    workflowStatus: 'complete',
    date: '2026-03-08',
    phase: 1,
    files: ['src/app/dashboard/page.tsx', 'src/components/command-center/PageHeader.tsx', 'src/components/command-center/Sidebar.tsx', 'src/lib/i18n.ts'],
    route: '/dashboard',
    notes: '4 stat cards (active projects, documents, avg health, today events). Recent projects list with health dots. Today events panel. Quick actions (New Project, New Document, Story Map). Added to sidebar navigation. PageKey "dashboard" registered.',
    notesHe: '4 כרטיסי סטטיסטיקה. רשימת פרויקטים אחרונים. פאנל אירועי היום. פעולות מהירות. נוסף לניווט סיידבר. מפתח עמוד "dashboard" נרשם.',
    purpose: 'Replaces the redirect-to-layers with a proper dashboard landing page showing project health, recent activity, events, and quick actions — giving users an overview before diving into specific tools.',
    purposeHe: 'מחליף את ההפניה ל-layers בעמוד בית דשבורד אמיתי המציג בריאות פרויקטים, פעילות אחרונה, אירועים ופעולות מהירות.',
    connectedTo: ['PageHeader.tsx', 'Sidebar.tsx', 'i18n.ts', 'api/events/today/route.ts', 'supabaseClient.ts'],
  },
  {
    id: 'forms-category',
    feature: 'Widget Store — Forms category + 3 form widgets (coming-soon)',
    featureHe: 'חנות ווידג\'טים — קטגוריית טפסים + 3 ווידג\'טים (בקרוב)',
    status: 'working',
    commitStatus: 'committed',
    workflowStatus: 'complete',
    date: '2026-03-08',
    phase: 5,
    files: ['src/components/command-center/widgets/WidgetRegistry.ts', 'src/components/command-center/widgets/WidgetStore.tsx'],
    route: '/dashboard',
    notes: 'Added "forms" to WidgetCategory type. 3 new coming-soon widgets: Origami Forms, Form Submissions, Document Scanner. Category label/emoji/order added to WidgetStore.',
    notesHe: 'הוספת "forms" לסוג WidgetCategory. 3 ווידג\'טים חדשים ב-coming-soon: טפסי Origami, הגשות טפסים, סורק מסמכים.',
    purpose: 'Expands the widget store with a dedicated Forms category, laying groundwork for Origami form integration and document scanning features.',
    purposeHe: 'מרחיב את חנות הווידג\'טים עם קטגוריית טפסים ייעודית, מניח תשתית לאינטגרציית טפסי Origami וסריקת מסמכים.',
    connectedTo: ['WidgetRegistry.ts', 'WidgetStore.tsx', 'i18n.ts'],
  },
  {
    id: 'api-route-fixes',
    feature: 'API route fixes — server client, auth, validation on notifications + events',
    featureHe: 'תיקוני נתיבי API — לקוח שרת, אימות, ולידציה בהתראות + אירועים',
    status: 'working',
    commitStatus: 'committed',
    workflowStatus: 'complete',
    date: '2026-03-08',
    phase: 5,
    files: ['src/app/api/notifications/route.ts', 'src/app/api/events/today/route.ts'],
    route: '',
    notes: 'Fixed 2 API routes using browser Supabase client instead of server client. Added requireAuth + Zod validation to notifications route. Scanned all API routes to confirm no remaining browser client usage.',
    notesHe: 'תוקנו 2 נתיבי API שהשתמשו בלקוח Supabase של הדפדפן במקום לקוח שרת. נוספו requireAuth + ולידציית Zod להתראות. נסרקו כל נתיבי ה-API.',
    purpose: 'Security fix: API routes must use server-side Supabase client (with cookie-based auth), not the browser client. Also added missing auth middleware and input validation.',
    purposeHe: 'תיקון אבטחה: נתיבי API חייבים להשתמש בלקוח Supabase של הצד-שרת, לא של הדפדפן. נוספו גם middleware אימות וולידציית קלט.',
    connectedTo: ['lib/api/auth.ts', 'lib/api/schemas.ts', 'lib/supabase/server.ts'],
  },
  ...
  {
    id: 'wati-widget',
    feature: 'WATI WhatsApp widget — live messages panel',
    featureHe: 'ווידג\'ט WATI — פאנל הודעות WhatsApp',
    status: 'working',
    commitStatus: 'committed',
    workflowStatus: 'complete',
    date: '2026-03-08',
    phase: 5,
    files: ['src/components/command-center/widgets/WATIWidget.tsx', 'src/components/command-center/widgets/WidgetRegistry.ts'],
    route: '/dashboard',
    notes: 'WhatsApp messages widget with demo data. Shows sender, preview, timestamp, read/unread status. Fetches from WATI API when NEXT_PUBLIC_WATI_URL is set. Factory function for demo data to avoid stale timestamps. Uses shared timeAgo utility.',
    notesHe: 'ווידג\'ט הודעות WhatsApp עם נתוני הדגמה. מציג שולח, תצוגה מקדימה, חותמת זמן, סטטוס נקרא/לא נקרא. שואב מ-WATI API כשמוגדר URL. פונקציית יצירה לנתוני הדגמה.',
    purpose: 'Brings WhatsApp communication visibility directly into the dashboard. Activated from coming-soon to active. Requires NEXT_PUBLIC_WATI_URL env var for live data.',
    purposeHe: 'מביא נראות תקשורת WhatsApp ישירות לדשבורד. הועבר ממצב coming-soon לפעיל. דורש משתנה סביבה NEXT_PUBLIC_WATI_URL לנתונים חיים.',
    connectedTo: ['WidgetRegistry.ts', 'lib/utils/timeAgo.ts'],
  },
  {
    id: 'team-widget',
    feature: 'Team status widget — who\'s online + roles',
    featureHe: 'ווידג\'ט צוות — מי מחובר + תפקידים',
    status: 'working',
    commitStatus: 'committed',
    workflowStatus: 'complete',
    date: '2026-03-08',
    phase: 5,
    files: ['src/components/command-center/widgets/TeamWidget.tsx', 'src/components/command-center/widgets/WidgetRegistry.ts'],
    route: '/dashboard',
    notes: 'Team members panel with online/away/offline status indicators. Shows name, role, and last active time. Demo data with 5 team members. Factory function for timestamps.',
    notesHe: 'פאנל חברי צוות עם אינדיקטורי סטטוס מחובר/לא זמין/לא מקוון. מציג שם, תפקיד וזמן פעילות אחרון. נתוני הדגמה של 5 חברי צוות.',
    purpose: 'Provides team visibility in the top bar — see who is online/available at a glance. Activated from coming-soon to active.',
    purposeHe: 'מספק נראות צוות בסרגל העליון — לראות מי מחובר/זמין במבט אחד. הועבר ממצב coming-soon לפעיל.',
    connectedTo: ['WidgetRegistry.ts', 'lib/utils/timeAgo.ts'],
  },
  {
    id: 'quality-audit-fixes',
    feature: 'Quality audit — 24 fixes across API auth, widget bugs, dashboard i18n',
    featureHe: 'ביקורת איכות — 24 תיקונים: אימות API, באגי ווידג\'טים, i18n דשבורד',
    status: 'working',
    commitStatus: 'committed',
    workflowStatus: 'complete',
    date: '2026-03-08',
    phase: 1,
    files: [
      'src/app/api/origami/entities/route.ts', 'src/app/api/installed-components/route.ts',
      'src/app/api/events/today/route.ts', 'src/app/api/weekly-planner/route.ts',
      'src/app/api/git/status/route.ts', 'src/app/api/system/snapshot/route.ts',
      'src/components/command-center/widgets/NotificationsWidget.tsx',
      'src/components/command-center/widgets/TimerWidget.tsx',
      'src/components/command-center/widgets/WATIWidget.tsx',
      'src/components/command-center/Sidebar.tsx',
      'src/components/command-center/PageHeader.tsx',
      'src/components/command-center/widgets/FavoritesWidget.tsx',
      'src/app/dashboard/page.tsx', 'src/lib/i18n.ts',
      'src/lib/utils/timeAgo.ts',
    ],
    route: '',
    notes: '3-part audit (56 findings): (1) API auth — cookie-based auth on 4 routes, execSync→execFileSync for shell injection prevention. (2) Widget bugs — duplicate listener fix, className space, setTimeout cleanups, stale Date.now() factory functions, shared timeAgo utility. (3) Dashboard quality — dashboardHome i18n (15 keys × 3 langs), error/retry UI, RTL dir, cc-favorites-change cross-component sync.',
    notesHe: 'ביקורת תלת-חלקית (56 ממצאים): (1) אימות API — אימות עוגיות ב-4 נתיבים, execSync→execFileSync למניעת הזרקת פקודות. (2) באגי ווידג\'טים — תיקון listener כפול, רווח className, ניקוי setTimeout, פונקציות יצירה. (3) איכות דשבורד — i18n של dashboardHome, UI שגיאה/ניסיון חוזר, RTL, סנכרון מועדפים.',
    purpose: 'Comprehensive quality pass across 18 files fixing critical security (command injection, missing auth), widget stability (memory leaks, stale state), and UX gaps (i18n, error handling, cross-component sync).',
    purposeHe: 'מעבר איכות מקיף על 18 קבצים — תיקוני אבטחה קריטיים, יציבות ווידג\'טים ופערי UX.',
    connectedTo: ['lib/api/auth.ts', 'lib/supabase/server.ts', 'lib/utils/timeAgo.ts', 'i18n.ts'],
  },
  {
    id: 'admin-data-sync',
    feature: 'Admin data.ts sync — added 7 widgets, 2 contexts, 2 routes, changelog entries',
    featureHe: 'סנכרון Admin data.ts — הוספת 7 ווידג\'טים, 2 קונטקסטים, 2 ראוטים, רשומות changelog',
    status: 'working',
    commitStatus: 'committed',
    workflowStatus: 'complete',
    date: '2026-03-08',
    phase: 1,
    files: ['src/app/dashboard/admin/data.ts'],
    route: '/dashboard/admin',
    notes: 'Synced admin registry with actual codebase: added dashboard-home + admin route entries, 4 missing widgets (kpi, shortcuts, wati, team), 2 missing contexts (AuthContext, ToastContext), and 12 changelog/checklist entries.',
    notesHe: 'סנכרון מרשם Admin עם קוד בסיס בפועל: הוספת ערכי ראוטים, 7 ווידג\'טים חסרים, 2 קונטקסטים חסרים, ו-12 רשומות changelog/checklist.',
    purpose: 'The admin registry is the single source of truth for the system overview. Keeping it in sync ensures the Changelog, Widget, Route, and Context tabs in /dashboard/admin reflect the actual state of the codebase.',
    purposeHe: 'מרשם ה-Admin הוא מקור האמת היחיד לסקירת המערכת. שמירה על סנכרון מבטיחה שהטאבים ב-/dashboard/admin משקפים את מצב הקוד בפועל.',
    connectedTo: ['admin/data.ts', 'WidgetRegistry.ts'],
  },
  {
    id: 'topbar-v2-bookmarks',
    feature: 'Widget Bar V2 — Bookmark system with linked editor notes',
    featureHe: 'סרגל ווידג\'טים V2 — מערכת סימניות עם הערות מקושרות לעורך',
    status: 'working',
    commitStatus: 'committed',
    workflowStatus: 'complete',
    date: '2026-03-08',
    phase: 3,
    files: [
      'src/components/command-center/widgets/FolderRegistry.ts',
      'src/components/command-center/widgets/BookmarkItemCell.tsx',
      'src/components/command-center/widgets/FolderItemCell.tsx',
      'src/components/command-center/widgets/FolderSettings.tsx',
      'src/lib/supabase/editorQueries.ts',
      'src/components/command-center/TopBar.tsx',
      'src/components/canvas/CanvasEditor.tsx',
      'src/components/editor/SourceBanner.tsx',
    ],
    route: '/dashboard',
    notes: 'New FolderItemBookmark type in folders with emoji icon, URL, and linked note_id. createBookmarkNote() follows createStoryNote() pattern. BookmarkItemCell renders bookmarks with note indicator. Quick Bookmark button in TopBar. SourceBanner extended with linkHref for bookmark-note record_type.',
    notesHe: 'סוג FolderItemBookmark חדש עם emoji, URL ו-note_id מקושר. BookmarkItemCell מרנדר סימניות עם אינדיקטור הערה. כפתור סימנייה מהירה בסרגל. SourceBanner הורחב עם linkHref.',
    purpose: 'Bookmarks are the core of the V2 redesign — every bookmark links to an editor note, making the top bar a knowledge hub. Quick Bookmark adds current page to __quick-bookmarks__ folder.',
    purposeHe: 'סימניות הן ליבת העיצוב מחדש V2 — כל סימנייה מקושרת להערת עורך, והופכת את הסרגל למרכז ידע.',
    connectedTo: ['FolderRegistry.ts', 'editorQueries.ts', 'CanvasEditor.tsx', 'SourceBanner.tsx'],
  },
  {
    id: 'topbar-v2-profiles',
    feature: 'Widget Bar V2 — Profile switcher + custom widget labels',
    featureHe: 'סרגל ווידג\'טים V2 — מחליף פרופילים + שמות מותאמים',
    status: 'working',
    commitStatus: 'committed',
    workflowStatus: 'complete',
    date: '2026-03-08',
    phase: 3,
    files: [
      'src/components/command-center/widgets/ProfileSwitcher.tsx',
      'src/contexts/WidgetContext.tsx',
      'src/components/command-center/widgets/WidgetWrapper.tsx',
      'src/components/command-center/widgets/WidgetSettings.tsx',
    ],
    route: '/dashboard',
    notes: 'ProfileSwitcher pill in TopBar with dropdown for all profiles (builtin + custom). Custom widget labels (widgetLabels state in WidgetContext, localStorage cc-widget-labels). Labels included in profile snapshots. WidgetSettings gets custom label input + reset + panel mode selector.',
    notesHe: 'ProfileSwitcher בסרגל עם dropdown לכל הפרופילים. שמות מותאמים לווידג\'טים (widgetLabels). תוויות נכללות בתמונת מצב של פרופילים.',
    purpose: 'Quick profile switching enables different workflows (e.g., focused writing vs full dashboard). Custom labels let users rename widgets to match their mental model.',
    purposeHe: 'מחליף פרופילים מאפשר מעבר מהיר בין תצורות שונות. שמות מותאמים מאפשרים למשתמשים להתאים ווידג\'טים למודל המנטלי שלהם.',
    connectedTo: ['WidgetContext.tsx', 'WidgetWrapper.tsx', 'WidgetSettings.tsx'],
  },
  {
    id: 'topbar-v2-display-modes',
    feature: 'Widget Bar V2 — Display modes (normal/_compact/icons-only) + universal side panel',
    featureHe: 'סרגל ווידג\'טים V2 — מצבי תצוגה + פאנל צד אוניברסלי',
    status: 'working',
    commitStatus: 'committed',
    workflowStatus: 'complete',
    date: '2026-03-08',
    ...
    files: [
      ...
      'src/components/command-center/widgets/WidgetWrapper.tsx',
      'src/components/command-center/DashboardShell.tsx',
      'src/components/command-center/widgets/UniversalSidePanel.tsx',
    ],
    route: '/dashboard',
    notes: '3 display modes (normal 48px / _compact 36px / icons-only 32px) with cycle button. Bar height, icon sizes, label visibility all respond to mode. DashboardShell adjusts top padding. UniversalSidePanel opens any widget as resizable side panel (300-700px, opposite of sidebar). widgetPanelModes state in WidgetContext.',
    notesHe: '3 מצבי תצוגה (רגיל/קומפקטי/אייקונים) עם כפתור מעבר. UniversalSidePanel פותח כל ווידג\'ט כפאנל צד. widgetPanelModes ב-WidgetContext.',
    purpose: 'Display modes give users control over screen real estate. Universal side panel extends the AI panel concept to all widgets — any widget can be pinned as a side panel.',
    purposeHe: 'מצבי תצוגה מאפשרים שליטה על שטח מסך. פאנל צד אוניברסלי מרחיב את הרעיון של פאנל ה-AI לכל ווידג\'ט.',
    connectedTo: ['WidgetContext.tsx', 'TopBar.tsx', 'DashboardShell.tsx', 'UniversalSidePanel.tsx'],
  },
  {
    id: 'topbar-v2-auto-pack',
    feature: 'Widget Bar V2 — Auto-pack + gap visualization in edit mode',
    featureHe: 'סרגל ווידג\'טים V2 — ארגון אוטומטי + ויזואליזציית רווחים במצב עריכה',
    status: 'working',
    commitStatus: 'committed',
    workflowStatus: 'complete',
    date: '2026-03-08',
    phase: 3,
    files: ['src/components/command-center/TopBar.tsx'],
    route: '/dashboard',
    notes: 'Auto-pack button in edit mode removes gaps while preserving relative order. Empty slots shown as dashed cells in edit mode for visual clarity.',
    notesHe: 'כפתור ארגון אוטומטי במצב עריכה מסיר רווחים תוך שמירה על סדר יחסי. רווחים ריקים מוצגים כתאים מקווקווים.',
    purpose: 'Auto-pack is a quality-of-life feature for users who frequently rearrange widgets. Gap visualization makes the grid structure visible and inviting for customization.',
    purposeHe: 'ארגון אוטומטי הוא פיצ\'ר נוחות למשתמשים שמסדרים ווידג\'טים לעתים קרובות.',
    connectedTo: ['TopBar.tsx', 'WidgetContext.tsx'],
  },

  // ── Phase 2: Entity Platform ── 2026-03-09
  {
    id: 'entity-platform',
    feature: 'Entity Platform — Global Fields, Entity Types, Views, NoteMeta',
    featureHe: 'פלטפורמת ישויות — שדות גלובליים, סוגי ישויות, תצוגות, NoteMeta',
    status: 'not-verified',
    commitStatus: 'uncommitted',
    ...
    phase: 2,
    files: [
      'supabase/migrations/20260340_global_fields.sql',
      'supabase/migrations/20260341_entity_types.sql',
      'supabase/migrations/20260342_field_groups.sql',
      'supabase/migrations/20260343_record_meta.sql',
      'src/lib/entities/types.ts',
      'src/lib/entities/builtinFields.ts',
      'src/lib/entities/builtinEntityTypes.ts',
      'src/lib/supabase/entityQueries.ts',
      'src/lib/supabase/fireberryBridge.ts',
      'src/app/dashboard/entities/fields/page.tsx',
      'src/app/dashboard/entities/types/page.tsx',
      'src/app/dashboard/entities/[type]/page.tsx',
      'src/components/entities/views/TableView.tsx',
      'src/components/entities/views/BoardView.tsx',
      'src/components/entities/views/ListView.tsx',
      'src/components/entities/views/CalendarView.tsx',
      'src/components/entities/NoteMeta.tsx',
      'src/components/entities/ConnectionDiagram.tsx',
      'src/components/canvas/CanvasEditor.tsx',
      'src/lib/i18n.ts',
      'src/components/command-center/Sidebar.tsx',
      'src/components/command-center/PageHeader.tsx',
    ],
    route: '/dashboard/entities/fields',
    notes: 'Full entity platform: Global fields (composite, select, multi-select, date, person, relation, formula), entity types as lenses on notes, field groups (repeating), note relations (many-to-many unlimited), 4 views (table/board/list/calendar), inline editing, cross-entity search, NoteMeta in canvas editor, Fireberry bridge, connection diagram.',
    notesHe: 'פלטפורמת ישויות מלאה: שדות גלובליים (מורכבים, בחירה, תאריך, אדם, קשר, נוסחה), סוגי ישויות כעדשות על פתקים, קבוצות שדות חוזרות, קשרי פתקים ללא הגבלה, 4 תצוגות (טבלה/לוח/רשימה/לוח שנה), עריכה inline, חיפוש חוצה ישויות, NoteMeta בעורך, גשר Fireberry, דיאגרמת קשרים.',
    purpose: 'The note is the universal atom — everything starts as a note and can become anything (task, client, project, agreement) by adding entity type fields. Replaces NocoDB/Notion/ClickUp with a unified internal platform. Many-to-many connections with no limits. Global fields defined once, reused everywhere.',
    purposeHe: 'הפתק הוא האטום האוניברסלי — הכל מתחיל כפתק ויכול להפוך לכל דבר (משימה, לקוח, פרויקט, הסכם) על ידי הוספת שדות ישות. מחליף NocoDB/Notion/ClickUp בפלטפורמה פנימית אחודה. קשרים many-to-many ללא הגבלה. שדות גלובליים מוגדרים פעם אחת ומשמשים בכל מקום.',
    connectedTo: ['editor', 'entity-fields', 'entity-types', 'entity-view'],
  },
  {
    id: 'entity-platform-p2',
    feature: 'Entity Platform Phase 2 — Templates, Gantt, Timeline, Activity, KPI, CRM types',
    featureHe: 'פלטפורמת ישויות פאזה 2 — תבניות, גאנט, ציר זמן, פעילות, KPI, סוגי CRM',
    status: 'not-verified',
    commitStatus: 'uncommitted',
    workflowStatus: 'inProgress',
    date: '2026-03-09',
    ...
    files: [
      ...
      'src/lib/entities/builtinFields.ts',
      'src/lib/entities/builtinEntityTypes.ts',
      'supabase/migrations/20260345_template_config.sql',
      'supabase/migrations/20260346_activity_log.sql',
      'supabase/migrations/20260347_note_events.sql',
      'src/lib/supabase/entityQueries.ts',
      'src/lib/supabase/kpiQueries.ts',
      'src/components/entities/ActivityFeed.tsx',
      'src/components/entities/views/GanttView.tsx',
      'src/components/entities/views/TimelineView.tsx',
      'src/app/dashboard/entities/[type]/page.tsx',
      'src/components/entities/NoteMeta.tsx',
      'src/lib/i18n.ts',
    ],
    route: '/dashboard/entities',
    notes: 'Phase 2 expansion: TemplateConfig (layout sections, view configs, activity/KPI tracking), 21 new fields (10 dev, 11 CRM), 4 new entity types (dev_task, deal, lead, agreement) with full template configs, 5 new connections, GanttView (pure SVG), TimelineView (pure CSS), ActivityFeed with comments and call logs, KPI event tracking, active/inactive toggle with status preservation.',
    notesHe: 'הרחבת פאזה 2: TemplateConfig (סקשנים, תצוגות, מעקב פעילות/KPI), 21 שדות חדשים (10 פיתוח, 11 CRM), 4 סוגי ישויות חדשים (משימת פיתוח, עסקה, ליד, הסכם) עם template configs מלאים, 5 חיבורים חדשים, GanttView (SVG טהור), TimelineView (CSS טהור), פיד פעילות עם תגובות ולוג שיחות, מעקב אירועי KPI, מצב פעיל/לא פעיל עם שימור סטטוס.',
    purpose: 'Transform the entity platform from a basic CRUD into a full CRM+ERP+Dev platform. Templates make the same note look and behave differently for each entity type. Activity log tracks every change for evidence culture. KPI events enable metric dashboards. Gantt/Timeline views for project management and deal pipeline visualization.',
    purposeHe: 'הפיכת פלטפורמת הישויות מ-CRUD בסיסי לפלטפורמת CRM+ERP+Dev מלאה. תבניות גורמות לאותו פתק להיראות ולהתנהג אחרת לכל סוג ישות. לוג פעילות עוקב אחרי כל שינוי לתרבות הראיות. אירועי KPI מאפשרים דשבורדי מטריקות. תצוגות גאנט/ציר זמן לניהול פרויקטים ותצוגת צנרת עסקאות.',
    connectedTo: ['entity-platform', 'editor', 'entity-fields', 'entity-types', 'entity-view'],
  },

  // ── Entity Action Buttons ── 2026-03-09
  {
    id: 'entity-action-buttons',
    feature: 'Entity Action Buttons — per-type configurable actions (toolbar + note sidebar)',
    featureHe: 'כפתורי פעולה בישויות — פעולות מותאמות לסוג (סרגל כלים + סיידבר פתק)',
    status: 'not-verified',
    commitStatus: 'uncommitted',
    workflowStatus: 'inProgress',
    date: '2026-03-09',
    ...
    files: [
      'src/lib/entities/types.ts',
      'src/lib/entities/actionRegistry.ts',
      'src/lib/entities/actionHandlers.ts',
      'src/lib/entities/resolveActions.ts',
      'src/components/entities/NoteActions.tsx',
    ...
    route: '/dashboard/entities',
    notes: 'Action buttons defined in actionRegistry.ts following WidgetRegistry pattern. resolveActions filters by scope + show_when conditions. EntityActionBar shows global actions always + bulk bar on selection. NoteActions shows single-note actions in NoteMeta sidebar. All 9 entity types now have action_buttons in template_config. i18n keys added for he/en/ru.',
    notesHe: 'כפתורי פעולה מוגדרים ב-actionRegistry.ts בעקבות דפוס WidgetRegistry. resolveActions מסנן לפי scope + show_when. EntityActionBar מציג פעולות גלובליות + בר בחירה מרובה. NoteActions מציג פעולות פתק בודד בסיידבר NoteMeta. כל 9 סוגי הישויות מכילים action_buttons ב-template_config. מפתחות i18n נוספו לעברית/אנגלית/רוסית.',
    purpose: 'Enable per-entity-type configurable actions that appear in both the entity page toolbar and individual note sidebar. Actions have visibility rules (scope, show_when), confirmation dialogs for destructive operations, and bulk support for multi-select operations. Follows the registry pattern for extensibility.',
    purposeHe: 'אפשור פעולות מותאמות לסוג ישות שמופיעות גם בסרגל הכלים של דף הישות וגם בסיידבר פתק בודד. לפעולות יש חוקי נראות (scope, show_when), דיאלוגי אישור לפעולות הרסניות ותמיכה בריבוי בחירה.',
    connectedTo: ['entity-platform', 'entity-platform-p2', 'entity-view'],
  },
  {
    id: 'entity-detail-page',
    feature: 'Entity Detail Page — full single-entity edit view',
    featureHe: 'עמוד פרטי ישות — תצוגת עריכה מלאה לישות בודדת',
    status: 'not-verified',
    commitStatus: 'uncommitted',
    workflowStatus: 'inProgress',
    date: '2026-03-09',
    phase: 2,
    files: [
      'src/app/dashboard/entities/[type]/[id]/page.tsx',
      'src/lib/supabase/entityQueries.ts',
      'src/components/entities/NoteMeta.tsx',
      'src/components/entities/StakeholderPanel.tsx',
      'src/components/entities/views/TableView.tsx',
      'src/components/entities/views/ListView.tsx',
      'src/components/entities/views/BoardView.tsx',
      'src/components/entities/views/CalendarView.tsx',
    ...
    route: '/dashboard/entities/[type]/[id]',
    notes: 'New route /dashboard/entities/[type]/[id] with breadcrumb, inline editable title (auto-save on blur), status bar, two-column layout: NoteMeta (fields/groups/relations/actions) on left, StakeholderPanel + ActivityFeed on right sidebar. Deactivate/reactivate + delete with confirm. All 4 list views (table/board/list/calendar) updated to link to detail page. Added fetchNote, updateNoteTitle, fetchNoteInfoBatch to entityQueries. NoteMeta gains hideSidebar prop to prevent duplicate StakeholderPanel/ActivityFeed. Relations now show note titles instead of UUIDs. StakeholderPanel contact links route to entity detail. i18n keys added (he/en/ru): backToList, lastEdited, createdAt, confirmDelete.',
    notesHe: 'נתיב חדש /dashboard/entities/[type]/[id] עם breadcrumb, כותרת ניתנת לעריכה (שמירה אוטומטית ב-blur), שורת סטטוס, פריסת שני טורים: NoteMeta (שדות/קבוצות/קשרים/פעולות) בצד הראשי, StakeholderPanel + ActivityFeed בסיידבר. השבתה/הפעלה מחדש + מחיקה עם אישור. כל 4 תצוגות הרשימה (טבלה/לוח/רשימה/לוח שנה) עודכנו עם לינקים לעמוד הפרטים. נוספו fetchNote, updateNoteTitle, fetchNoteInfoBatch ל-entityQueries. NoteMeta קיבל prop hideSidebar למניעת רנדור כפול. קשרים מציגים כעת כותרות במקום UUIDs. לינקי בעלי עניין מפנים לעמוד פרטי ישות. מפתחות i18n נוספו (עברית/אנגלית/רוסית).',
    purpose: 'Provides a dedicated full-page view for editing a single entity note. Before this, editing only happened inline in list views — no way to see all fields, stakeholders, activity, and actions together. The detail page is the canonical editing surface for any entity type, reusing NoteMeta, StakeholderPanel, and ActivityFeed as layout-level components in a two-column responsive grid.',
    purposeHe: 'מספק תצוגת עמוד מלא ייעודית לעריכת פתק ישות בודד. לפני כן, עריכה התבצעה רק inline בתצוגות רשימה — לא הייתה דרך לראות את כל השדות, בעלי עניין, פעילות ופעולות יחד. עמוד הפרטים הוא משטח העריכה הקנוני לכל סוג ישות, תוך שימוש חוזר ב-NoteMeta, StakeholderPanel ו-ActivityFeed כרכיבי פריסה ברשת שני טורים רספונסיבית.',
    connectedTo: ['entity-platform', 'entity-platform-p2', 'entity-action-buttons', 'entity-view'],
  },
  {
    id: 'entity-search-cmdk',
    feature: 'Entity Search in Cmd+K (SearchWidget)',
    featureHe: 'חיפוש ישויות ב-Cmd+K (SearchWidget)',
    status: 'not-verified',
    commitStatus: 'uncommitted',
    workflowStatus: 'inProgress',
    date: '2026-03-09',
    ...
    route: '/dashboard',
    notes: 'SearchWidget now searches entity records (vb_records with entity_type) via searchNotes() alongside documents. Results grouped by entity type with emoji icons. Links to /dashboard/entities/[type]/[id].',
    notesHe: 'ווידג\'ט החיפוש מחפש כעת גם רשומות ישויות (vb_records עם entity_type) באמצעות searchNotes() לצד מסמכים. תוצאות מקובצות לפי סוג ישות עם אייקוני אמוג\'י. קישור ל-/dashboard/entities/[type]/[id].',
    purpose: 'Makes all CRM entities searchable from the global Cmd+K search modal, not just documents and pages.',
    purposeHe: 'הופך את כל ישויות ה-CRM לחפישות מתוך מודל החיפוש הגלובלי Cmd+K, ולא רק מסמכים ודפים.',
    connectedTo: ['search-widget', 'entity-platform'],
  },
  {
    id: 'template-editor-ui',
    feature: 'Template Editor UI for Entity Types',
    featureHe: 'עורך תבניות UI לסוגי ישויות',
    status: 'not-verified',
    commitStatus: 'uncommitted',
    workflowStatus: 'inProgress',
    date: '2026-03-09',
    phase: 2,
    files: [
      'src/components/entities/TemplateEditor.tsx',
      'src/app/dashboard/entities/types/page.tsx',
      'src/lib/i18n.ts',
    ],
    route: '/dashboard/entities/types',
    notes: 'New TemplateEditor component (~350 lines) added as a "Template" tab in entity type edit modal. Configures: available views with board/gantt/timeline sub-configs, layout sections with field assignment, meta columns, track_activity/kpi toggles, action buttons manager. All trilingual (he/en/ru).',
    notesHe: 'רכיב TemplateEditor חדש (~350 שורות) נוסף כלשונית "תבנית" במודל עריכת סוג ישות. מגדיר: תצוגות זמינות עם הגדרות לוח/גאנט/ציר זמן, סקציות פריסה עם שיוך שדות, עמודות מטא, מתגי מעקב פעילות/KPI, מנהל כפתורי פעולה. תלת-לשוני (עברית/אנגלית/רוסית).',
    purpose: 'Enables UI-based editing of template_config JSONB — previously only editable via code. Core CRM configurability: entity types can now be fully customized through the dashboard UI.',
    purposeHe: 'מאפשר עריכת template_config JSONB דרך ממשק — בעבר ניתן היה לערוך רק דרך קוד. יכולת הגדרה מרכזית ל-CRM: סוגי ישויות ניתנים כעת להתאמה מלאה דרך ממשק הדשבורד.',
    connectedTo: ['entity-platform', 'entity-platform-p2', 'entity-types'],
  },
  {
    id: 'template-linking',
    feature: 'TipTap Template Linking for Entity Instances',
    featureHe: 'קישור תבניות TipTap לישויות',
    status: 'not-verified',
    commitStatus: 'uncommitted',
    workflowStatus: 'inProgress',
    date: '2026-03-09',
    phase: 2,
    files: [
      'src/components/entities/TemplatePicker.tsx',
      'src/lib/supabase/entityQueries.ts',
      'src/app/dashboard/entities/[type]/[id]/page.tsx',
      'src/lib/i18n.ts',
    ],
    route: '/dashboard/entities/[type]/[id]',
    notes: 'TemplatePicker component in entity detail sidebar. Link/unlink templates via note_relations (relation_type=template). Search + create templates inline. Open linked template in full editor. Added fetchLinkedTemplates, linkTemplate, unlinkTemplate, searchTemplates, createTemplate to entityQueries.',
    notesHe: 'רכיב TemplatePicker בסיידבר עמוד פרטי ישות. קישור/ביטול קישור תבניות דרך note_relations (relation_type=template). חיפוש + יצירת תבניות inline. פתיחת תבנית מקושרת בעורך מלא. נוספו fetchLinkedTemplates, linkTemplate, unlinkTemplate, searchTemplates, createTemplate ל-entityQueries.',
    purpose: 'Connects the rich-text editor (TipTap) to the entity platform. Each entity can have linked templates/documents for structured content alongside structured data fields.',
    purposeHe: 'מחבר את עורך הטקסט העשיר (TipTap) לפלטפורמת הישויות. לכל ישות יכולות להיות תבניות/מסמכים מקושרים לתוכן מובנה לצד שדות נתונים מובנים.',
    connectedTo: ['entity-platform', 'entity-detail-page', 'editor'],
  },
  {
    id: 'rbac',
    feature: 'Role-Based Access Control (Per-Page + Per-Entity)',
    featureHe: 'בקרת גישה מבוססת תפקידים (לפי עמוד + לפי ישות)',
    status: 'not-verified',
    commitStatus: 'uncommitted',
    workflowStatus: 'inProgress',
    date: '2026-03-09',
    ...
    route: '/dashboard',
    notes: 'AuthContext extended with UserRole (admin/manager/member/viewer/external), UserPermissions, resolvePermissions(). requireAdmin checks app_metadata.role; new requireRole() for granular checks. Sidebar filters pages by visiblePages for external users. NoteMeta filters fields by stakeholder visible_fields for viewer/external. i18n keys for role labels.',
    notesHe: 'AuthContext הורחב עם UserRole (admin/manager/member/viewer/external), UserPermissions, resolvePermissions(). requireAdmin בודק app_metadata.role; requireRole() חדש לבדיקות גרנולריות. Sidebar מסנן עמודים לפי visiblePages למשתמשים חיצוניים. NoteMeta מסנן שדות לפי visible_fields של בעלי עניין ל-viewer/external. מפתחות i18n לתוויות תפקידים.',
    purpose: 'Foundation for access control: role-based page visibility and field-level filtering based on stakeholder permissions. Currently soft-enforced (client-side), with server-side enforcement via requireAdmin/requireRole in API routes.',
    purposeHe: 'בסיס לבקרת גישה: נראות עמודים מבוססת תפקידים וסינון ברמת שדה על בסיס הרשאות בעלי עניין. כרגע אכיפה רכה (צד לקוח), עם אכיפה בצד שרת דרך requireAdmin/requireRole בנתיבי API.',
    connectedTo: ['entity-platform', 'entity-detail-page', 'sidebar'],
  },
  {
    id: 'saved-views',
    feature: 'Saved Views — Preset Filters per Entity Type',
    featureHe: 'תצוגות שמורות — פילטרים מוגדרים מראש לפי סוג ישות',
    status: 'not-verified',
    commitStatus: 'uncommitted',
    workflowStatus: 'inProgress',
    date: '2026-03-09',
    ...
    route: '/dashboard/entities/[type]',
    notes: 'SavedView type added to types.ts. Entity list page gains saved views dropdown: save current view+filters+sort as named preset, load/delete presets, auto-detect manual changes. Persisted in localStorage per entity type. Outside-click close. Trilingual i18n keys.',
    notesHe: 'טיפוס SavedView נוסף ל-types.ts. דף רשימת ישויות מקבל תפריט תצוגות שמורות: שמירת תצוגה+פילטרים+מיון כפריסט עם שם, טעינה/מחיקה, זיהוי אוטומטי של שינויים ידניים. שמור ב-localStorage לפי סוג ישות. סגירה בלחיצה בחוץ. מפתחות i18n תלת-לשוניים.',
    purpose: 'Users can save filter+sort+view combinations as named presets per entity type, reducing repetitive filtering. localStorage-based, instant apply.',
    purposeHe: 'משתמשים יכולים לשמור שילובי פילטר+מיון+תצוגה כפריסטים עם שם לפי סוג ישות, מה שמקטין סינון חוזר. מבוסס localStorage, החלה מיידית.',
    connectedTo: ['entity-platform', 'entity-list-views'],
  },
  {
    id: 'smart-field-keys',
    feature: 'Smart Field Keys — Auto-ID, Aliases & Merge',
    featureHe: 'מפתחות שדה חכמים — מזהה אוטומטי, שמות חלופיים ומיזוג',
    status: 'not-verified',
    commitStatus: 'uncommitted',
    workflowStatus: 'inProgress',
    date: '2026-03-09',
    ...
    route: '/dashboard/entities/fields',
    notes: 'meta_key is now auto-generated from field label (locked after creation). New `aliases: string[]` on GlobalField enables backwards-compatible key resolution. resolveField() checks both meta_key and aliases. Merge action moves source field\'s meta_key into target\'s aliases and deletes source. Field library UI updated: locked meta_key badge, aliases section in edit modal, merge picker modal. Trilingual i18n keys.',
    notesHe: 'meta_key נוצר אוטומטית מתווית השדה (נעול לאחר יצירה). שדה `aliases: string[]` חדש ב-GlobalField מאפשר רזולוציה תואמת אחורה. resolveField() בודק גם meta_key וגם aliases. פעולת מיזוג מעבירה את ה-meta_key של שדה המקור ל-aliases של היעד ומוחקת את המקור. ממשק ספריית השדות עודכן: תג meta_key נעול, מקטע aliases בעריכה, מודל בוחר מיזוג. מפתחות i18n תלת-לשוניים.',
    purpose: 'Eliminates manual meta_key entry (error-prone). Aliases enable field merging without breaking existing data — old keys transparently resolve to the canonical field. Critical for CRM data quality as the entity platform scales.',
    purposeHe: 'מבטל הקלדה ידנית של meta_key (מועד לשגיאות). שמות חלופיים מאפשרים מיזוג שדות בלי לשבור נתונים קיימים — מפתחות ישנים מופנים בשקיפות לשדה הקנוני. קריטי לאיכות נתוני CRM ככל שפלטפורמת הישויות מתרחבת.',
    connectedTo: ['entity-platform', 'field-library'],
  },
  {
    id: 'bulk-field-update-permissions',
    feature: 'Bulk Field Update + Action Permissions',
    featureHe: 'עדכון שדה גורף + מערכת הרשאות פעולות',
    status: 'not-verified',
    commitStatus: 'uncommitted',
    workflowStatus: 'inProgress',
    date: '2026-03-09',
    phase: 2,
    files: [
      'src/lib/supabase/permissionQueries.ts',
      'src/components/entities/BulkFieldUpdateModal.tsx',
      'src/contexts/AuthContext.tsx',
      'src/lib/entities/resolveActions.ts',
      'src/lib/entities/actionRegistry.ts',
      'src/lib/entities/actionHandlers.ts',
    ...
    route: '/dashboard/entities/[type]',
    notes: 'Three new bulk actions (field _update, status change, assign) with multi-step modal. Per-user action permissions via user_action_permissions table with role-based fallback. resolveActions filters by canPerformAction. bulkUpdateMeta enhanced with activity tracking. All 9 entity types wired with bulk actions.',
    notesHe: 'שלוש פעולות גורפות חדשות (עדכון שדה, שינוי סטטוס, הקצאה) עם מודל רב-שלבי. הרשאות פעולות לכל משתמש דרך טבלת user_action_permissions עם fallback לפי תפקיד. resolveActions מסנן לפי canPerformAction. bulkUpdateMeta משופר עם מעקב פעילות. כל 9 סוגי הישויות מחוברים עם פעולות גורפות.',
  ...
  },
  {
    ...
    purpose: 'Adds an operational AI mode that can understand work _context, suggest actions, and present structured previews before execution. Unlike chat/analyze/write/decompose modes that produce text, Work Manager bridges AI reasoning with dashboard actions — previewing entity updates, status changes, and task assignments before committing them.',
  ...
  },
  {
    ...
    purpose: 'Provides a structured knowledge base that the AI assistant can learn from to better understand business needs. Wiki entries with Q&A pairs serve as training _context, bridging business domain knowledge with AI capabilities.',
  ...
  },
  {
    ...
    route: '/api/export',
    notes: 'General-purpose CSV export API endpoint supporting document_submissions, vb_records, and document_audit_log. Hebrew column _headers, UTF-8 BOM for Excel compatibility, status translations, date formatting. Reusable ExportButton component with loading state and toast notifications. Integrated into Documents page.',
  ...
  {
    id: 'skin-system',
    feature: '3-Layer Skin System',
    featureHe: 'מערכת סקינים 3 שכבות',
    status: 'working',
    commitStatus: 'uncommitted',
    workflowStatus: 'complete',
    date: '2026-03-17',
    ...
    files: [
      ...
      'src/components/settings/SkinsTab.tsx',
      'src/contexts/SettingsContext.tsx',
      'src/components/command-center/MobileBottomBar.tsx',
      'src/components/command-center/DashboardShell.tsx',
      'src/app/globals.css',
      'src/lib/i18n.ts',
    ],
    route: '/dashboard/settings',
    notes: '3 independent skin layers: Shell (6 skins — sidebar/topbar frame), Content (6 skins — card/page styling), Mobile Nav (6 skins — bottom bar, hamburger, FAB, swipe drawer, tab+drawer, bottom sheet). Each layer independently selectable. CSS data-attribute targeting for shell/content, component-level rendering for mobile nav. Persisted in localStorage via SettingsContext.',
    notesHe: '3 שכבות סקין עצמאיות: Shell (6 — מסגרת סיידבר/טופבר), Content (6 — עיצוב כרטיסיות/דפים), Mobile Nav (6 — סרגל תחתון, המבורגר, FAB, מגירה, טאבים, גיליון). כל שכבה נבחרת בנפרד. CSS data-attributes לשל/תוכן, רינדור ברמת קומפוננטה למובייל. נשמר ב-localStorage דרך SettingsContext.',
    purpose: 'Enables full visual customization — users pick their preferred navigation frame, page layout style, and mobile navigation independently. 216 possible combinations (6×6×6). Every mobile skin guarantees escape-hatch navigation.',
    purposeHe: 'מאפשר התאמה אישית ויזואלית מלאה — המשתמשים בוחרים מסגרת ניווט, סגנון דפים וניווט מובייל בנפרד. 216 שילובים אפשריים (6×6×6). כל סקין מובייל מבטיח דרך חזרה לתפריט.',
    connectedTo: ['Settings Page', 'DashboardShell', 'MobileBottomBar', 'Sidebar'],
  },
  {
    id: 'sidebar-customization',
    feature: 'Sidebar Customization (DnD, folders, hide/show)',
    featureHe: 'התאמת סיידבר (גרור, תיקיות, הסתר/הצג)',
    status: 'working',
    commitStatus: 'uncommitted',
    workflowStatus: 'complete',
    date: '2026-03-17',
    phase: 2,
    files: [
      'src/lib/sidebar/sidebarCustomization.ts',
      'src/lib/sidebar/useSidebarCustomization.ts',
      'src/components/command-center/SidebarContextMenu.tsx',
      'src/components/command-center/Sidebar.tsx',
      'src/lib/i18n.ts',
    ],
    notes: 'Drag-to-reorder sidebar items via @dnd-kit, custom user folders, hide/show items, auto-sort by usage tracking, right-click context menu. All persisted in localStorage.',
    notesHe: 'גרור לסידור מחדש פריטי סיידבר דרך @dnd-kit, תיקיות מותאמות אישית, הסתרה/הצגה, מיון אוטומטי לפי שימוש, תפריט הקשר בלחיצה ימנית. הכל נשמר ב-localStorage.',
    purpose: 'Gives users full control over sidebar organization — reorder, group, hide rarely-used items. Auto-sort surfaces most-used items first.',
    purposeHe: 'נותן למשתמשים שליטה מלאה על ארגון הסיידבר — סידור מחדש, קיבוץ, הסתרת פריטים שלא בשימוש. מיון אוטומטי מעלה פריטים נפוצים.',
    connectedTo: ['Sidebar', 'DashboardShell'],
  },
];
