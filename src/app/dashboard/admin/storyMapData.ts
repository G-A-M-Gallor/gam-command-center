...
export const userJourneySteps: UserJourneyStep[] = [
  // ── Step 1: Authenticate ──
  {
    ...
    name: 'Authenticate',
    nameHe: 'הזדהות',
    primaryPages: ['/login', '/auth/callback', 'proxy.ts'],
    currentStatus: 'Working',
    currentStatusHe: 'עובד',
    emotion: 'Neutral → small delight (dark theme login)',
    emotionHe: 'ניטרלי → שמחה קטנה (לוגין בערכת נושא כהה)',
    friction: 'None — proxy.ts auth guard active',
    frictionHe: 'אין — proxy.ts הגנת אותנטיקציה פעילה',
    stories: [
  ...
  // ── Step 5: Plan & Map Work ──
  {
    ...
    friction: 'Demo mode when no project selected',
    frictionHe: 'מצב הדגמה כשלא נבחר פרויקט',
    ...
    stories: [
      ...
      { name: 'plan_phases table', nameHe: 'טבלת plan_phases', status: 'done', risk: 'low', note: 'Migration: 20260331_create_plan_phases.sql', noteHe: 'מיגרציה: 20260331_create_plan_phases.sql' },
      { name: 'Story card notes (expandable)', nameHe: 'פתקי כרטיס סיפור (מורחבים)', status: 'done', risk: 'low', keyFile: 'src/components/command-center/StoryCard.tsx' },
      { name: 'Story card diagrams (Mermaid)', nameHe: 'דיאגרמות כרטיס סיפור (Mermaid)', status: 'done', risk: 'low', keyFile: 'src/components/command-center/StoryCard.tsx' },
      { name: 'Story card estimation (T-shirt)', nameHe: 'הערכת כרטיס סיפור (T-shirt)', status: 'done', risk: 'low', note: 'XS/S/M/L/XL with point mapping (1/2/3/5/8)', noteHe: 'XS/S/M/L/XL עם מיפוי נקודות (1/2/3/5/8)' },
      { name: 'Filter/search bar', nameHe: 'סרגל סינון/חיפוש', status: 'done', risk: 'low', keyFile: 'src/components/command-center/StoryMapFilterBar.tsx' },
      { name: 'Stats summary with completion tracking', nameHe: 'סיכום סטטיסטי עם מעקב השלמה', status: 'done', risk: 'low', keyFile: 'src/components/command-center/StoryMapStats.tsx' },
      { name: 'Board export (JSON/Markdown/PNG)', nameHe: 'ייצוא לוח (JSON/Markdown/PNG)', status: 'done', risk: 'low', keyFile: 'src/components/command-center/StoryMapExport.tsx' },
      { name: 'URL persistence for project selection', nameHe: 'שמירת פרויקט נבחר ב-URL', status: 'done', risk: 'low' },
    ],
  ...
  // ── Step 7: Understand Organization ──
  {
    ...
    currentStatus: 'Working (local + Supabase)',
    currentStatusHe: 'עובד (מקומי + Supabase)',
  ...
  // ── Step 8: Customize & Administer ──
  {
    ...
    stories: [
      { name: 'Language toggle (he/en/ru)', nameHe: 'מתג שפה (he/en/ru)', status: 'done', risk: 'low' },
      ...
      { name: 'Russian language support (full i18n)', nameHe: 'תמיכת שפה רוסית (i18n מלא)', status: 'done', risk: 'low' },
    ],
...
export const mvp: ReleaseTier = {
  ...
  tasks: [
    { name: 'Fix middleware → proxy.ts (Walking Skeleton)', nameHe: 'תקן middleware → proxy.ts (הוכחת ארכיטקטורה)', status: 'DONE', statusHe: 'הושלם', effort: '5 min', risk: 'low' },
    { name: 'Create functional_map_cells table', nameHe: 'צור טבלת functional_map_cells', status: 'DONE', statusHe: 'הושלם', effort: '15 min', risk: 'low' },
    { name: 'Create plan_phases table', nameHe: 'צור טבלת plan_phases', status: 'DONE', statusHe: 'הושלם', effort: '15 min', risk: 'low' },
    ...
    { name: 'RLS policies for new tables', nameHe: 'מדיניות RLS לטבלאות חדשות', status: 'DONE', statusHe: 'הושלם', effort: '30 min', risk: 'low' },
...
export const mlpTiers: MLPTier[] = [
  ...
  },
  {
    ...
    features: [
      { name: 'Story card notes (expandable)', nameHe: 'פתקי כרטיס סיפור (מורחבים)', why: 'More context per card', whyHe: 'יותר הקשר לכרטיס', effort: 'S', risk: 'low', status: 'done' },
      { name: 'Story card estimation (T-shirt)', nameHe: 'הערכת כרטיס סיפור (T-shirt)', why: 'Sprint planning', whyHe: 'תכנון ספרינט', effort: 'S', risk: 'low', status: 'done' },
      { name: 'AI-assisted decomposition', nameHe: 'פירוק בסיוע AI', why: 'Bridge to AI Hub', whyHe: 'גשר למרכז AI', effort: 'M', risk: 'medium' },
      { name: 'Story Map export (JSON/Markdown/PNG)', nameHe: 'ייצוא מפת סיפורים (JSON/Markdown/PNG)', why: 'Stakeholder sharing', whyHe: 'שיתוף בעלי עניין', effort: 'M', risk: 'low', status: 'done' },
    ],
  },
  {
    id: 'tier-d',
  ...
  },
  {
    ...
    features: [
      { name: 'Sidebar redesign (innovative nav)', nameHe: 'עיצוב סיידבר חדש (ניווט חדשני)', why: 'Core UX improvement', whyHe: 'שיפור UX ליבה', effort: 'L', risk: 'low', status: 'done' },
...
export const implementationSequence: WeekPlan[] = [
  {
    ...
    tasks: [
      '✓ proxy.ts verified, migrations run, env vars set',
      '✓ All 12 pages verified end-to-end',
      '✓ RLS policies added, limitations documented',
    ],
    tasksHe: [
      '✓ proxy.ts אומת, מיגרציות הורצו, משתני סביבה הוגדרו',
      '✓ כל 12 הדפים אומתו מקצה לקצה',
      '✓ מדיניות RLS נוספו, מגבלות תועדו',
    ],
  },
  {
  ...
  {
    week: 'Week 4: MLP Tier B+C (Editor + Story Map) — largely done',
    weekHe: 'שבוע 4: שכבה ב׳+ג׳ MLP (עורך + מפת סיפורים) — ברובו הושלם',
    tasks: [
      '✓ Story card notes, diagrams, estimation — all built',
      '✓ Filter bar, stats, board export — all built',
      'Remaining: AI-assisted decomposition, field library expansion',
    ],
    tasksHe: [
      '✓ פתקי כרטיס, דיאגרמות, הערכה — הכל נבנה',
      '✓ סרגל סינון, סטטיסטיקה, ייצוא לוח — הכל נבנה',
      'נותר: פירוק בסיוע AI, הרחבת ספריית שדות',
    ],
  },
  {
    week: 'Week 5: MLP Tier D+E (AI + UX Polish) — sidebar done',
    weekHe: 'שבוע 5: שכבה ד׳+ה׳ MLP (AI + ליטוש UX) — סיידבר הושלם',
    tasks: [
      '✓ Sidebar redesign with grouped navigation + sliding indicator',
      'Remaining: Context injection, keyboard shortcuts, split-screen',
    ],
    tasksHe: [
      '✓ עיצוב סיידבר חדש עם ניווט מקובץ + אינדיקטור גולש',
      'נותר: הזרקת הקשר, קיצורי מקלדת, מסך מפוצל',
    ],
  },
  {
