...
const planChecks: AuditCheck[] = [
  ...
  },
  {
    ...
    result: 'warn',
    detail: 'CLAUDE.md says "❌ Multi-theme — dark mode only". However, skins.ts (123 lines) and StyleOverrideContext (275 lines) implement accent color theming. Still dark-only, but more theme customization than planned.',
    detailHe: 'CLAUDE.md אומר "❌ ריבוי ערכות נושא — מצב כהה בלבד". עם זאת, skins.ts (123 שורות) ו-StyleOverrideContext (275 שורות) מממשים התאמת צבע דגש. עדיין כהה בלבד, אבל יותר התאמה אישית מתוכנן.',
...
const integrityChecks: AuditCheck[] = [
  ...
  },
  {
    ...
    result: 'warn',
    detail: 'Large uncommitted diff. Includes admin/, designs/, embeds/, landing/, skins.ts. Risk of losing work.',
    detailHe: 'diff גדול לא שמור. כולל admin/, designs/, embeds/, landing/, skins.ts. סיכון לאובדן עבודה.',
