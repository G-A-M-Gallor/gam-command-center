...
const realityChecks: AuditCheck[] = [
  ...
  },
  {
    ...
    result: 'pass',
    detail: 'SettingsContext.tsx (457 lines) persists: language, sidebarPosition, sidebarVisibility, accentColor, density, _brandProfile, styleOverrides. All via localStorage.',
...
const qualityChecks: AuditCheck[] = [
  {
    ...
    recommendationHe: 'הוסף vitest + @testing-library/react. עדיפות: ספקי _context, פונקציות שאילתא, מודולי שירות.',
  },
  {
    id: 'large-file-admin',
    hat: 'quality',
  ...
  },
  {
    ...
    result: 'info',
    detail: 'Contains brand _profile, accent colors, skins, style overrides, density settings. Rich functionality justifies size.',
