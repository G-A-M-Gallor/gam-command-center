import {
  ...
  Calendar, CalendarCheck, CalendarDays, CalendarPlus, CalendarRange, CalendarX, Camera, Check, CheckCircle2, CheckSquare, ChevronRight, Circle, CircleDot, Clipboard, _Clock, Cloud, Code, Cog, Coins, Command, Copy, CreditCard,
  Database, DollarSign, Download,
  Edit3, _ExternalLink, Eye,
  ...
  Image, Inbox, Info,
  Key,
  Landmark, Languages, _Layers, Layout, LifeBuoy, Link, Link2, List, ListChecks, Lock, LogIn,
  Mail, Map, MapPin, Megaphone, MessageCircle, MessageSquare, Mic, _Monitor, Moon, MoreHorizontal,
  Navigation,
  Package, Palette, Palmtree, PenTool, Percent, Phone, PhoneCall, Pin, Play, Plug, _Plus, Printer,
  QrCode,
  Radio, Receipt, RefreshCw, Repeat, Rocket, Ruler,
  Save, Scale, Scan, Search, Send, Server, Settings, Share2, _Shield, ShoppingCart, Smile, Speaker, _Star, StickyNote, Sun, Swords,
